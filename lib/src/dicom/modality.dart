...
class Modality {
  ...
  static const Modality BDUS =
      const Modality("BDUS", "Bone Densitometry (ultrasound)", MClass.ACQUISITION, false, null);
  static const Modality BI =
      const Modality("BI", "Biomagnetic imaging", MClass.ACQUISITION, false, null);
  static const Modality BMD =
  ...
  static const Modality DX =
      const Modality("DX", "Digital Radiography", MClass.ACQUISITION, false, null);
  static const Modality ECG =
      const Modality("ECG", "Electrocardiography", MClass.ACQUISITION, false, null);
  static const Modality EPS =
      const Modality("EPS", "Cardiac Electrophysiology", MClass.ACQUISITION, false, null);
  ...
  static const Modality GM =
      const Modality("GM", "General Microscopy", MClass.ACQUISITION, false, null);
  static const Modality HC = const Modality("HC", "Hard Copy", MClass.OTHER, false, null);
  static const Modality HD =
      const Modality("HD", "Hemodynamic Waveform", MClass.ACQUISITION, false, null);
  static const Modality IO =
      const Modality("IO", "Intra-Oral Radiography", MClass.ACQUISITION, false, null);
  static const Modality IOL =
      const Modality("IOL", "Intraocular Lens Data", MClass.ACQUISITION, false, null);
  static const Modality IVOCT = const Modality(
      "IVOCT", "Intravascular Optical Coherence Tomography", MClass.ACQUISITION, false, null);
  static const Modality IVUS =
      const Modality("IVUS", "Intravascular Ultrasound", MClass.ACQUISITION, false, null);
  static const Modality KER = const Modality("KER", "Keratometry", MClass.ACQUISITION, false, null);
  static const Modality KO =
      const Modality("KO", "Key Object Selection", MClass.POST_PROCESSING, false, null);
  static const Modality LEN = const Modality("LEN", "Lensometry", MClass.ACQUISITION, false, null);
  static const Modality LS =
      const Modality("LS", "Laser surface scan", MClass.ACQUISITION, false, null);
  static const Modality MG = const Modality("MG", "Mammography", MClass.ACQUISITION, false, null);
  static const Modality MR =
      const Modality("MR", "Magnetic Resonance", MClass.ACQUISITION, false, null);
  static const Modality NM =
      const Modality("NM", "Nuclear Medicine", MClass.ACQUISITION, false, null);
  static const Modality OAM =
      const Modality("OAM", "Ophthalmic Axial Measurements", MClass.POST_PROCESSING, false, null);
  static const Modality OCT = const Modality(
      "OCT", "Optical Coherence Tomography (non-Ophthalmic)", MClass.ACQUISITION, false, null);
  static const Modality OPM =
      const Modality("OPM", "Ophthalmic Mapping", MClass.POST_PROCESSING, false, null);
  static const Modality OP =
      const Modality("OP", "Ophthalmic Photography", MClass.ACQUISITION, false, null);
  static const Modality OPT =
      const Modality("OPT", "Ophthalmic Tomography", MClass.ACQUISITION, false, null);
  static const Modality OPV =
      const Modality("OPV", "Ophthalmic Visual Field", MClass.ACQUISITION, false, null);
  static const Modality OSS =
      const Modality("OSS", "Optical Surface Scan", MClass.ACQUISITION, false, null);
  ...
  static const Modality REG =
      const Modality("REG", "Registration", MClass.POST_PROCESSING, false, null);
  static const Modality RESP =
      const Modality("RESP", "Respiratory Waveform", MClass.ACQUISITION, false, null);
  static const Modality RF =
      const Modality("RF", "Radio Fluoroscopy", MClass.ACQUISITION, false, null);
  static const Modality RG = const Modality(
      "RG", "Radiographic imaging (conventional film/screen)", MClass.ACQUISITION, false, null);
  static const Modality RTDOSE =
      const Modality("RTDOSE", "Radiotherapy Dose", MClass.ACQUISITION, false, null);
  static const Modality RTIMAGE =
      const Modality("RTIMAGE", "Radiotherapy Image", MClass.ACQUISITION, false, null);
  static const Modality RTPLAN =
      const Modality("RTPLAN", "Radiotherapy Plan", MClass.POST_PROCESSING, false, null);
  static const Modality RTRECORD =
      const Modality("RTRECORD", "RT Treatment Record", MClass.DOCUMENT, false, null);
  static const Modality RTSTRUCT =
      const Modality("RTSTRUCT", "Radiotherapy Structure Set", MClass.PLANNING, false, null);
  static const Modality SEG =
      const Modality("SEG", "Segmentation", MClass.POST_PROCESSING, false, null);
  static const Modality SMR =
      const Modality("SMR", "Stereometric Relationship", MClass.OTHER, false, null);
  static const Modality SM =
      const Modality("SM", "Slide Microscopy", MClass.ACQUISITION, false, null);
  static const Modality SRF =
      const Modality("SRF", "Subjective Refraction", MClass.ACQUISITION, false, null);
  static const Modality SR = const Modality("SR", "SR Document", MClass.DOCUMENT, false, null);
  static const Modality STAIN =
      const Modality("STAIN", "Automated Slide Stainer", MClass.ACQUISITION, false, null);
  ...
  static const Modality XA =
      const Modality("XA", "X-Ray Angiography", MClass.ACQUISITION, false, null);
  ...
  static const Modality DF =
      const Modality("DF", "Digital fluoroscopy", MClass.ACQUISITION, true, RF);
  static const Modality DM =
      const Modality("DM", "Digital microscopy", MClass.ACQUISITION, true, null);
  static const Modality DS =
      const Modality("DS", "Digital Subtraction Angiography", MClass.ACQUISITION, true, XA);
  static const Modality EC = const Modality("EC", "Echocardiography", MClass.ACQUISITION, true, US);
  static const Modality FA =
      const Modality("FA", "Fluorescein angiography", MClass.ACQUISITION, true, null);
  ...
  static const Modality MA =
      const Modality("MA", "Magnetic resonance angiography", MClass.ACQUISITION, true, MR);
  static const Modality MS =
      const Modality("MS", "Magnetic resonance spectroscopy", MClass.ACQUISITION, true, MR);
  static const Modality OPR =
      const Modality("OPR", "Ophthalmic Refraction", MClass.ACQUISITION, true, null);
