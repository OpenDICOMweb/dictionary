...
class VR {
  ...
  static const List<VR> stringVRs = const [
    VR.kAE, VR.kAS, VR.kBR, VR.kCS, VR.kDA, VR.kDS, VR.kDT, VR.kIS, VR.kLO,
    VR.kLT, VR.kPN, VR.kSH, VR.kST, VR.kTM, VR.kUC, VR.kUI, VR.kUR, VR.kUT
  ];

  static const List<VR> byteVRs = const [
    VR.kAT, VR.kFD, VR.kFL, VR.kOB, VR.kOD, VR.kOF,
    VR.kOW, VR.kSL, VR.kSS, VR.kUL, VR.kUN, VR.kUS
  ];

  static const List<VR> intVRs = const [
    VR.kAT, VR.kOB, VR.kOW, VR.kSL, VR.kSS, VR.kUL, VR.kUS, VR.kDS, VR.kIS
  ];
  static const List<VR> floatVRs = const [
    VR.kFD, VR.kFL, VR.kOD, VR.kOF
  ];
