...
class Tag extends TagBase {
  ...
  static const Tag kAffectedSOPInstanceUID = const Tag(
      "AffectedSOPInstanceUID", 0x00001000, "Affected SOP Instance UID ", VR.kUI, VM.k1, false);

  static const Tag kRequestedSOPInstanceUID = const Tag(
  ...
  static const Tag kFileMetaInformationGroupLength = const Tag("FileMetaInformationGroupLength",
                                                                     0x00020000, "File Meta Information Group Length", VR.kUL, VM.k1, false);

  static const Tag kFileMetaInformationVersion = const Tag("FileMetaInformationVersion", 0x00020001,
                                                                 "File Meta Information Version", VR.kOB, VM.k1, false);

  static const Tag kMediaStorageSOPClassUID = const Tag(
      "MediaStorageSOPClassUID", 0x00020002, "Media Storage SOP Class UID", VR.kUI, VM.k1, false);

  static const Tag kMediaStorageSOPInstanceUID = const Tag("MediaStorageSOPInstanceUID", 0x00020003,
                                                                 "Media Storage SOP Instance UID", VR.kUI, VM.k1, false);

  static const Tag kTransferSyntaxUID =
  const Tag("TransferSyntaxUID", 0x00020010, "Transfer Syntax UID", VR.kUI, VM.k1, false);

  static const Tag kImplementationClassUID = const Tag(
      "ImplementationClassUID", 0x00020012, "Implementation Class UID", VR.kUI, VM.k1, false);

  static const Tag kImplementationVersionName = const Tag(
      "ImplementationVersionName", 0x00020013, "Implementation Version Name", VR.kSH, VM.k1, false);

  static const Tag kSourceApplicationEntityTitle = const Tag("SourceApplicationEntityTitle", 0x00020016,
                                                                   "Source ApplicationEntity Title", VR.kAE, VM.k1, false);

  static const Tag kSendingApplicationEntityTitle = const Tag("SendingApplicationEntityTitle",
                                                                    0x00020017, "Sending Application Entity Title", VR.kAE, VM.k1, false);

  static const Tag kReceivingApplicationEntityTitle = const Tag("ReceivingApplicationEntityTitle",
                                                                      0x00020018, "Receiving Application Entity Title", VR.kAE, VM.k1, false);

  static const Tag kPrivateInformationCreatorUID = const Tag("PrivateInformationCreatorUID", 0x00020100,
                                                                   "Private Information Creator UID", VR.kUI, VM.k1, false);

  static const Tag kPrivateInformation =
  ...
  static const Tag kPrivateDataElementCharacteristicsSequence = const Tag(
  ...
  static const Tag kPrivateGroupReference = const Tag(
      "PrivateGroupReference", 0x00080301, "Private Group Reference", VR.kUS, VM.k1, false);

  static const Tag kPrivateCreatorReference = const Tag(
      "PrivateCreatorReference", 0x00080302, "Private Creator Reference", VR.kLO, VM.k1, false);

  static const Tag kBlockIdentifyingInformationStatus = const Tag("BlockIdentifyingInformationStatus",
                                                                        0x00080303, "Block Identifying Information Status", VR.kCS, VM.k1, false);

  static const Tag kNonidentifyingPrivateElements = const Tag("NonidentifyingPrivateElements",
                                                                    0x00080304, "Nonidentifying Private Elements", VR.kUS, VM.k1_n, false);
  static const Tag kDeidentificationActionSequence = const Tag("DeidentificationActionSequence",
                                                                     0x00080305, "Deidentification Action Sequence", VR.kSQ, VM.k1, false);
  static const Tag kIdentifyingPrivateElements = const Tag("IdentifyingPrivateElements", 0x00080306,
                                                                 "Identifying Private Elements", VR.kUS, VM.k1_n, false);
  static const Tag kDeidentificationAction = const Tag(
