...
//TODO: change the type from String to UidType
...
class WKUid extends Uid {
  ...
  static const kVerificationSOPClass =
      const WKUid("1.2.840.10008.1.1", UidType.kSopClass, false, "Verification SOP Class", "PS3.4");
  ...
  static const kExplicitVRLittleEndian = const WKUid(
      "1.2.840.10008.1.2.1", UidType.kTransferSyntax, false, "Explicit VR Little Endian", "PS3.5");
  static const kDeflatedExplicitVRLittleEndian = const WKUid("1.2.840.10008.1.2.1.99",
      UidType.kTransferSyntax, false, "Deflated Explicit VR Little Endian", "PS3.5");
  static const kExplicitVRBigEndian_Retired = const WKUid("1.2.840.10008.1.2.2",
      UidType.kTransferSyntax, true, "Explicit VR Big Endian (Retired)", "PS3.5");
  ...
  static const kJPEGExtended_3_5_Retired = const WKUid("1.2.840.10008.1.2.4.52",
      UidType.kTransferSyntax, true, "JPEG Extended (Process 3 & 5) (Retired)", "PS3.5");
  ...
  static const kJPEGLosslessNon_Hierarchical_14 = const WKUid("1.2.840.10008.1.2.4.57",
      UidType.kTransferSyntax, false, "JPEG Lossless, Non-Hierarchical (Process 14)", "PS3.5");
  ...
  static const kJPEGLosslessHierarchical_28_Retired = const WKUid("1.2.840.10008.1.2.4.65",
      UidType.kTransferSyntax, true, "JPEG Lossless, Hierarchical (Process 28) (Retired)", "PS3.5");
  static const kJPEGLosslessHierarchical_29_Retired = const WKUid("1.2.840.10008.1.2.4.66",
      UidType.kTransferSyntax, true, "JPEG Lossless, Hierarchical (Process 29) (Retired)", "PS3.5");
  ...
  static const kJPEG_LSLosslessImageCompression = const WKUid("1.2.840.10008.1.2.4.80",
      UidType.kTransferSyntax, false, "JPEG-LS Lossless Image Compression", "PS3.5");
  static const kJPEG_LSLossyImageCompression = const WKUid("1.2.840.10008.1.2.4.81",
      UidType.kTransferSyntax, false, "JPEG-LS Lossy (Near-Lossless) Image Compression", "PS3.5");
  static const kJPEG2000ImageCompressionLosslessOnly = const WKUid("1.2.840.10008.1.2.4.90",
      UidType.kTransferSyntax, false, "JPEG 2000 Image Compression Lossless Only", "PS3.5");
  static const kJPEG2000ImageCompression = const WKUid("1.2.840.10008.1.2.4.91",
      UidType.kTransferSyntax, false, "JPEG 2000 Image Compression", "PS3.5");
  ...
  static const kJPIPReferenced = const WKUid(
      "1.2.840.10008.1.2.4.94", UidType.kTransferSyntax, false, "JPIP Referenced", "PS3.5");
  static const kJPIPReferencedDeflate = const WKUid(
      "1.2.840.10008.1.2.4.95", UidType.kTransferSyntax, false, "JPIP Referenced Deflate", "PS3.5");
  static const kMPEG2MainProfile_MainLevel = const WKUid("1.2.840.10008.1.2.4.100",
      UidType.kTransferSyntax, false, "MPEG2 Main Profile @ Main Level", "PS3.5");
  static const kMPEG2MainProfile_HighLevel = const WKUid("1.2.840.10008.1.2.4.101",
      UidType.kTransferSyntax, false, "MPEG2 Main Profile @ High Level", "PS3.5");
  static const kMPEG_4AVC_H264HighProfile_Level41 = const WKUid("1.2.840.10008.1.2.4.102",
      UidType.kTransferSyntax, false, "MPEG-4 AVC/H.264 High Profile / Level 4.1", "PS3.5");
  ...
  static const kRLELossless =
      const WKUid("1.2.840.10008.1.2.5", UidType.kTransferSyntax, false, "RLE Lossless", "PS3.5");
  static const kRFC2557MIMEencapsulation = const WKUid("1.2.840.10008.1.2.6.1",
      UidType.kTransferSyntax, false, "RFC 2557 MIME encapsulation", "PS3.10");
  static const kXMLEncoding = const WKUid(
      "1.2.840.10008.1.2.6.2", UidType.kTransferSyntax, false, "XML Encoding", "PS3.10");
  static const kMediaStorageDirectoryStorage = const WKUid(
      "1.2.840.10008.1.3.10", UidType.kSopClass, false, "Media Storage Directory Storage", "PS3.4");
  static const kTalairachBrainAtlasFrameofReference = const WKUid("1.2.840.10008.1.4.1.1",
      UidType.kFrameOfReference, false, "Talairach Brain Atlas Frame of Reference", "");
  static const kSPM2T1FrameofReference = const WKUid(
      "1.2.840.10008.1.4.1.2", UidType.kFrameOfReference, false, "SPM2 T1 Frame of Reference", "");
  static const kSPM2T2FrameofReference = const WKUid(
      "1.2.840.10008.1.4.1.3", UidType.kFrameOfReference, false, "SPM2 T2 Frame of Reference", "");
  static const kSPM2PDFrameofReference = const WKUid(
      "1.2.840.10008.1.4.1.4", UidType.kFrameOfReference, false, "SPM2 PD Frame of Reference", "");
  static const kSPM2EPIFrameofReference = const WKUid(
      "1.2.840.10008.1.4.1.5", UidType.kFrameOfReference, false, "SPM2 EPI Frame of Reference", "");
  static const kSPM2FILT1FrameofReference = const WKUid("1.2.840.10008.1.4.1.6",
      UidType.kFrameOfReference, false, "SPM2 FIL T1 Frame of Reference", "");
  static const kSPM2PETFrameofReference = const WKUid(
      "1.2.840.10008.1.4.1.7", UidType.kFrameOfReference, false, "SPM2 PET Frame of Reference", "");
  static const kSPM2TRANSMFrameofReference = const WKUid("1.2.840.10008.1.4.1.8",
      UidType.kFrameOfReference, false, "SPM2 TRANSM Frame of Reference", "");
  static const kSPM2SPECTFrameofReference = const WKUid("1.2.840.10008.1.4.1.9",
      UidType.kFrameOfReference, false, "SPM2 SPECT Frame of Reference", "");
  static const kSPM2GRAYFrameofReference = const WKUid("1.2.840.10008.1.4.1.10",
      UidType.kFrameOfReference, false, "SPM2 GRAY Frame of Reference", "");
  static const kSPM2WHITEFrameofReference = const WKUid("1.2.840.10008.1.4.1.11",
      UidType.kFrameOfReference, false, "SPM2 WHITE Frame of Reference", "");
  static const kSPM2CSFFrameofReference = const WKUid("1.2.840.10008.1.4.1.12",
      UidType.kFrameOfReference, false, "SPM2 CSF Frame of Reference", "");
  static const kSPM2BRAINMASKFrameofReference = const WKUid("1.2.840.10008.1.4.1.13",
      UidType.kFrameOfReference, false, "SPM2 BRAINMASK Frame of Reference", "");
  static const kSPM2AVG305T1FrameofReference = const WKUid("1.2.840.10008.1.4.1.14",
      UidType.kFrameOfReference, false, "SPM2 AVG305T1 Frame of Reference", "");
  static const kSPM2AVG152T1FrameofReference = const WKUid("1.2.840.10008.1.4.1.15",
      UidType.kFrameOfReference, false, "SPM2 AVG152T1 Frame of Reference", "");
  static const kSPM2AVG152T2FrameofReference = const WKUid("1.2.840.10008.1.4.1.16",
      UidType.kFrameOfReference, false, "SPM2 AVG152T2 Frame of Reference", "");
  static const kSPM2AVG152PDFrameofReference = const WKUid("1.2.840.10008.1.4.1.17",
      UidType.kFrameOfReference, false, "SPM2 AVG152PD Frame of Reference", "");
  static const kSPM2SINGLESUBJT1FrameofReference = const WKUid("1.2.840.10008.1.4.1.18",
      UidType.kFrameOfReference, false, "SPM2 SINGLESUBJT1 Frame of Reference", "");
  static const kICBM452T1FrameofReference = const WKUid("1.2.840.10008.1.4.2.1",
      UidType.kFrameOfReference, false, "ICBM 452 T1 Frame of Reference", "");
  static const kICBMSingleSubjectMRIFrameofReference = const WKUid("1.2.840.10008.1.4.2.2",
      UidType.kFrameOfReference, false, "ICBM Single Subject MRI Frame of Reference", "");
  ...
  static const kPETColorPaletteSOPInstance = const WKUid("1.2.840.10008.1.5.2",
      UidType.kColorPalette, false, "PET Color Palette SOP Instance", "PS 3.6");
  static const kHotMetalBlueColorPaletteSOPInstance = const WKUid("1.2.840.10008.1.5.3",
      UidType.kColorPalette, false, "Hot Metal Blue Color Palette SOP Instance", "PS 3.6");
  static const kPET20StepColorPaletteSOPInstance = const WKUid("1.2.840.10008.1.5.4",
      UidType.kSopInstance, false, "PET 20 Step Color Palette SOP Instance", "PS 3.6");
  static const kBasicStudyContentNotificationSOPClass_Retired = const WKUid("1.2.840.10008.1.9",
      UidType.kSopClass, true, "Basic Study Content Notification SOP Class (Retired)", "PS3.4");
  static const kStorageCommitmentPushModelSOPClass = const WKUid("1.2.840.10008.1.20.1",
      UidType.kSopClass, true, "Storage Commitment Push Model SOP Class", "PS3.4");
  static const kStorageCommitmentPushModelSOPInstance = const WKUid("1.2.840.10008.1.20.1.1",
      UidType.kSopInstance, false, "Storage Commitment Push Model SOP Instance", "PS3.4");
  static const kStorageCommitmentPullModelSOPClass_Retired = const WKUid("1.2.840.10008.1.20.2",
      UidType.kSopClass, true, "Storage Commitment Pull Model SOP Class (Retired)", "PS3.4");
  ...
  static const kProceduralEventLoggingSOPClass = const WKUid("1.2.840.10008.1.40",
      UidType.kSopClass, false, "Procedural Event Logging SOP Class", "PS3.4");
  static const kProceduralEventLoggingSOPInstance = const WKUid("1.2.840.10008.1.40.1",
      UidType.kSopInstance, false, "Procedural Event Logging SOP Instance", "PS3.4");
  static const kSubstanceAdministrationLoggingSOPClass = const WKUid("1.2.840.10008.1.42",
      UidType.kSopClass, false, "Substance Administration Logging SOP Class", "PS3.4");
  static const kSubstanceAdministrationLoggingSOPInstance = const WKUid("1.2.840.10008.1.42.1",
      UidType.kSopInstance, false, "Substance Administration Logging SOP Instance", "PS3.4");
  static const kDICOMUIDRegistry = const WKUid(
      "1.2.840.10008.2.6.1", UidType.kDicomCodingScheme, false, "DICOM UID Registry", "PS 3.6");
  static const kDICOMControlledTerminology = const WKUid("1.2.840.10008.2.16.4",
      UidType.kCodingScheme, false, "DICOM Controlled Terminology", "PS3.16");
  static const kDICOMApplicationContextName = const WKUid("1.2.840.10008.3.1.1.1",
      UidType.kApplicationContextName, false, "DICOM Application Context Name", "PS3.7");
  static const kDetachedPatientManagementSOPClass_Retired = const WKUid("1.2.840.10008.3.1.2.1.1",
      UidType.kSopClass, true, "Detached Patient Management SOP Class (Retired)", "PS3.4");
  ...
  static const kDetachedVisitManagementSOPClass_Retired = const WKUid("1.2.840.10008.3.1.2.2.1",
      UidType.kSopClass, true, "Detached Visit Management SOP Class (Retired)", "PS3.4");
  static const kDetachedStudyManagementSOPClass_Retired = const WKUid("1.2.840.10008.3.1.2.3.1",
      UidType.kSopClass, true, "Detached Study Management SOP Class (Retired)", "PS3.4");
  static const kStudyComponentManagementSOPClass_Retired = const WKUid("1.2.840.10008.3.1.2.3.2",
      UidType.kSopClass, true, "Study Component Management SOP Class (Retired)", "PS3.4");
  static const kModalityPerformedProcedureStepSOPClass = const WKUid("1.­2.840.10008.3.1.2.3.3",
      UidType.kSopClass, false, "Modality Performed Procedure Step SOP Class", "PS3.4");
  ...
  static const kDetachedResultsManagementSOPClass_Retired = const WKUid("1.2.840.10008.3.1.2.5.1",
      UidType.kSopClass, true, "Detached Results Management SOP Class (Retired)", "PS3.4");
  ...
  static const kDetachedStudyManagementMetaSOPClass_Retired = const WKUid("1.2.840.10008.3.1.2.5.5",
      UidType.kMetaSopClass, true, "Detached Study Management Meta SOP Class (Retired)", "PS3.4");
  ...
  static const kStorageServiceClass = const WKUid(
      "1.2.840.10008.4.2", UidType.kServiceClass, false, "Storage Service Class", "PS3.4");
  static const kBasicFilmSessionSOPClass = const WKUid(
      "1.2.840.10008.5.1.1.1", UidType.kSopClass, false, "Basic Film Session SOP Class", "PS3.4");
  static const kBasicFilmBoxSOPClass = const WKUid(
      "1.2.840.10008.5.1.1.2", UidType.kSopClass, false, "Basic Film Box SOP Class", "PS3.4");
  static const kBasicGrayscaleImageBoxSOPClass = const WKUid("1.2.840.10008.5.1.1.4",
      UidType.kSopClass, false, "Basic Grayscale Image Box SOP Class", "PS3.4");
  static const kBasicColorImageBoxSOPClass = const WKUid("1.2.840.10008.5.1.1.4.1",
      UidType.kSopClass, false, "Basic Color Image Box SOP Class", "PS3.4");
  static const kReferencedImageBoxSOPClass_Retired = const WKUid("1.2.840.10008.5.1.1.4.2",
      UidType.kSopClass, true, "Referenced Image Box SOP Class (Retired)", "PS3.4");
  static const kBasicGrayscalePrintManagementMetaSOPClass = const WKUid("1.2.840.10008.5.1.1.9",
      UidType.kMetaSopClass, false, "Basic Grayscale Print Management Meta SOP Class", "PS3.4");
  ...
  static const kPrintJobSOPClass = const WKUid(
      "1.2.840.10008.5.1.1.14", UidType.kSopClass, false, "Print Job SOP Class", "PS3.4");
  static const kBasicAnnotationBoxSOPClass = const WKUid("1.2.840.10008.5.1.1.15",
      UidType.kSopClass, false, "Basic Annotation Box SOP Class", "PS3.4");
  static const kPrinterSOPClass =
      const WKUid("1.2.840.10008.5.1.1.16", UidType.kSopClass, false, "Printer SOP Class", "PS3.4");
  static const kPrinterConfigurationRetrievalSOPClass = const WKUid("1.2.840.10008.5.1.1.16.376",
      UidType.kSopClass, false, "Printer Configuration Retrieval SOP Class", "PS3.4");
  static const kPrinterSOPInstance = const WKUid("1.2.840.10008.5.1.1.17",
      UidType.kPrinterSopInstance, false, "Printer SOP Instance", "PS3.4");
  static const kPrinterConfigurationRetrievalSOPInstance = const WKUid("1.2.840.10008.5.1.1.17.376",
      UidType.kPrinterSopInstance, false, "Printer Configuration Retrieval SOP Instance", "PS3.4");
  static const kBasicColorPrintManagementMetaSOPClass = const WKUid("1.2.840.10008.5.1.1.18",
      UidType.kMetaSopClass, false, "Basic Color Print Management Meta SOP Class", "PS3.4");
  ...
  static const kVOILUTBoxSOPClass = const WKUid(
      "1.2.840.10008.5.1.1.22", UidType.kSopClass, false, "VOI LUT Box SOP Class", "PS3.4");
  static const kPresentationLUTSOPClass = const WKUid(
      "1.2.840.10008.5.1.1.23", UidType.kSopClass, false, "Presentation LUT SOP Class", "PS3.4");
  static const kImageOverlayBoxSOPClass_Retired = const WKUid("1.2.840.10008.5.1.1.24",
      UidType.kSopClass, true, "Image Overlay Box SOP Class (Retired)", "PS3.4");
  static const kBasicPrintImageOverlayBoxSOPClass_Retired = const WKUid("1.2.840.10008.5.1.1.24.1",
      UidType.kSopClass, true, "Basic Print Image Overlay Box SOP Class (Retired)", "PS3.4");
  static const kPrintQueueSOPInstance_Retired = const WKUid("1.2.840.10008.5.1.1.25",
      UidType.kPrintQueueSopInstance, true, "Print Queue SOP Instance (Retired)", "PS3.4");
  static const kPrintQueueManagementSOPClass_Retired = const WKUid("1.2.840.10008.5.1.1.26",
      UidType.kSopClass, true, "Print Queue Management SOP Class (Retired)", "PS3.4");
  static const kStoredPrintStorageSOPClass_Retired = const WKUid("1.2.840.10008.5.1.1.27",
      UidType.kSopClass, true, "Stored Print Storage SOP Class (Retired)", "PS3.4");
  ...
  static const kHardcopyColorImageStorageSOPClass_Retired = const WKUid("1.2.840.10008.5.1.1.30",
      UidType.kSopClass, true, "Hardcopy Color Image Storage SOP Class (Retired)", "PS3.4");
  static const kPullPrintRequestSOPClass_Retired = const WKUid("1.2.840.10008.5.1.1.31",
      UidType.kSopClass, true, "Pull Print Request SOP Class (Retired)", "PS3.4");
  ...
  static const kMediaCreationManagementSOPClassUID = const WKUid("1.2.840.10008.5.1.1.33",
      UidType.kSopClass, false, "Media Creation Management SOP Class UID", "PS3.4");
  static const kComputedRadiographyImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.1",
      UidType.kSopClass, false, "Computed Radiography Image Storage", "PS3.4");
  ...
  static const kX_Ray3DAngiographicImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.13.1.1",
      UidType.kSopClass, false, "X-Ray 3D Angiographic Image Storage", "PS3.4");
  static const kX_Ray3DCraniofacialImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.13.1.2",
      UidType.kSopClass, false, "X-Ray 3D Craniofacial Image Storage", "PS3.4");
  static const kBreastTomosynthesisImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.13.1.3",
      UidType.kSopClass, false, "Breast Tomosynthesis Image Storage", "PS3.4");
  ...
  static const kVLPhotographicImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.77.1.4",
      UidType.kSopClass, false, "VL Photographic Image Storage", "PS3.4");
  static const kVideoPhotographicImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.77.1.4.1",
      UidType.kSopClass, false, "Video Photographic Image Storage", "PS3.4");
  ...
  static const kStandalonePETCurveStorage_Retired = const WKUid("1.2.840.10008.5.1.4.1.1.129",
      UidType.kSopClass, true, "Standalone PET Curve Storage (Retired)", "PS3.4");
  static const kEnhancedPETImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.130",
      UidType.kSopClass, false, "Enhanced PET Image Storage", "PS3.4");
  static const kBasicStructuredDisplayStorage = const WKUid("1.2.840.10008.5.1.4.1.1.131",
      UidType.kSopClass, false, "Basic Structured Display Storage", "PS3.4");
  static const kRTImageStorage = const WKUid(
      "1.2.840.10008.5.1.4.1.1.481.1", UidType.kSopClass, false, "RT Image Storage", "PS3.4");
  static const kRTDoseStorage = const WKUid(
      "1.2.840.10008.5.1.4.1.1.481.2", UidType.kSopClass, false, "RT Dose Storage", "PS3.4");
  static const kRTStructureSetStorage = const WKUid("1.2.840.10008.5.1.4.1.1.481.3",
      UidType.kSopClass, false, "RT Structure Set Storage", "PS3.4");
  static const kRTBeamsTreatmentRecordStorage = const WKUid("1.2.840.10008.5.1.4.1.1.481.4",
      UidType.kSopClass, false, "RT Beams Treatment Record Storage", "PS3.4");
  static const kRTPlanStorage = const WKUid(
      "1.2.840.10008.5.1.4.1.1.481.5", UidType.kSopClass, false, "RT Plan Storage", "PS3.4");
  static const kRTBrachyTreatmentRecordStorage = const WKUid("1.2.840.10008.5.1.4.1.1.481.6",
      UidType.kSopClass, false, "RT Brachy Treatment Record Storage", "PS3.4");
  static const kRTTreatmentSummaryRecordStorage = const WKUid("1.2.840.10008.5.1.4.1.1.481.7",
      UidType.kSopClass, false, "RT Treatment Summary Record Storage", "PS3.4");
  static const kRTIonPlanStorage = const WKUid(
      "1.2.840.10008.5.1.4.1.1.481.8", UidType.kSopClass, false, "RT Ion Plan Storage", "PS3.4");
  static const kRTIonBeamsTreatmentRecordStorage = const WKUid("1.2.840.10008.5.1.4.1.1.481.9",
      UidType.kSopClass, false, "RT Ion Beams Treatment Record Storage", "PS3.4");
  static const kDICOSCTImageStorage = const WKUid(
      "1.2.840.10008.5.1.4.1.1.501.1", UidType.kSopClass, false, "DICOS CT Image Storage", "DICOS");
  ...
  static const kDICOSThreatDetectionReportStorage = const WKUid("1.2.840.10008.5.1.4.1.1.501.3",
      UidType.kSopClass, false, "DICOS Threat Detection Report Storage", "DICOS");
  static const kDICOS2DAITStorage = const WKUid(
      "1.2.840.10008.5.1.4.1.1.501.4", UidType.kSopClass, false, "DICOS 2D AIT Storage", "DICOS");
  static const kDICOS3DAITStorage = const WKUid(
      "1.2.840.10008.5.1.4.1.1.501.5", UidType.kSopClass, false, "DICOS 3D AIT Storage", "DICOS");
  static const kDICOSQuadrupoleResonanceStorage = const WKUid("1.2.840.10008.5.1.4.1.1.501.6",
      UidType.kSopClass, false, "DICOS Quadrupole Resonance (QR) Storage", "DICOS");
  static const kEddyCurrentImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.601.1",
      UidType.kSopClass, false, "Eddy Current Image Storage", "DICONDE ASTM E2934");
  static const kEddyCurrentMulti_frameImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.601.2",
      UidType.kSopClass, false, "Eddy Current Multi-frame Image Storage", "DICONDE ASTM E2934");
  ...
  static const kCompositeInstanceRootRetrieve_MOVE = const WKUid("1.2.840.10008.5.1.4.1.2.4.2",
      UidType.kSopClass, false, "Composite Instance Root Retrieve - MOVE", "PS3.4");
  static const kCompositeInstanceRootRetrieve_GET = const WKUid("1.2.840.10008.5.1.4.1.2.4.3",
      UidType.kSopClass, false, "Composite Instance Root Retrieve - GET", "PS3.4");
  ...
  static const kModalityWorklistInformationModel_FIND = const WKUid("1.2.840.10008.5.1.4.31",
      UidType.kSopClass, false, "Modality Worklist Information Model - FIND", "PS3.4");
  ...
  static const kInstanceAvailabilityNotificationSOPClass = const WKUid("1.2.840.10008.5.1.4.33",
      UidType.kSopClass, false, "Instance Availability Notification SOP Class", "PS3.4");
  ...
  static const kRTIonMachineVerification_Trial_Retired = const WKUid("1.2.840.10008.5.1.4.34.3",
      UidType.kSopClass, true, "RT Ion Machine Verification - Trial (Retired)", "PS3.4");
  ...
  static const kUnifiedWorklistandProcedureStepSOPInstance = const WKUid("1.2.840.10008.5.1.4.34.5",
      UidType.kSopInstance, false, "Unified Worklist and Procedure Step SOP Instance", "PS3.4");
  ...
  static const kGenericImplantTemplateInformationModel_GET = const WKUid("1.2.840.10008.5.1.4.43.4",
      UidType.kSopClass, false, "Generic Implant Template Information Model - GET", "PS3.4");
  static const kImplantAssemblyTemplateStorage = const WKUid("1.2.840.10008.5.1.4.44.1",
      UidType.kSopClass, false, "Implant Assembly Template Storage", "PS3.4");
  ...
  static const kImplantTemplateGroupStorage = const WKUid("1.2.840.10008.5.1.4.45.1",
      UidType.kSopClass, false, "Implant Template Group Storage", "PS3.4");
  static const kImplantTemplateGroupInformationModel_FIND = const WKUid("1.2.840.10008.5.1.4.45.2",
      UidType.kSopClass, false, "Implant Template Group Information Model - FIND", "PS3.4");
  static const kImplantTemplateGroupInformationModel_MOVE = const WKUid("1.2.840.10008.5.1.4.45.3",
      UidType.kSopClass, false, "Implant Template Group Information Model - MOVE", "PS3.4");
  static const kImplantTemplateGroupInformationModel_GET = const WKUid("1.2.840.10008.5.1.4.45.4",
      UidType.kSopClass, false, "Implant Template Group Information Model - GET", "PS3.4");
  static const kNativeDICOMModel = const WKUid("1.2.840.10008.7.1.1",
      UidType.kApplicationHostingModel, false, "Native DICOM Model", "PS3.19");
  static const kAbstractMulti_DimensionalImageModel = const WKUid("1.2.840.10008.7.1.2",
      UidType.kApplicationHostingModel, false, "Abstract Multi-Dimensional Image Model", "PS3.19");
  static const kdicomDeviceName =
      const WKUid("1.2.840.10008.15.0.3.1", UidType.kLdapOid, false, "dicomDeviceName", "PS3.15");
  static const kdicomDescription =
      const WKUid("1.2.840.10008.15.0.3.2", UidType.kLdapOid, false, "dicomDescription", "PS3.15");
  static const kdicomManufacturer =
      const WKUid("1.2.840.10008.15.0.3.3", UidType.kLdapOid, false, "dicomManufacturer", "PS3.15");
  static const kdicomManufacturerModelName = const WKUid(
      "1.2.840.10008.15.0.3.4", UidType.kLdapOid, false, "dicomManufacturerModelName", "PS3.15");
  static const kdicomSoftwareVersion = const WKUid(
      "1.2.840.10008.15.0.3.5", UidType.kLdapOid, false, "dicomSoftwareVersion", "PS3.15");
  static const kdicomVendorData =
      const WKUid("1.2.840.10008.15.0.3.6", UidType.kLdapOid, false, "dicomVendorData", "PS3.15");
  static const kdicomAETitle =
      const WKUid("1.2.840.10008.15.0.3.7", UidType.kLdapOid, false, "dicomAETitle", "PS3.15");
  static const kdicomNetworkConnectionReference = const WKUid("1.2.840.10008.15.0.3.8",
      UidType.kLdapOid, false, "dicomNetworkConnectionReference", "PS3.15");
  static const kdicomApplicationCluster = const WKUid(
      "1.2.840.10008.15.0.3.9", UidType.kLdapOid, false, "dicomApplicationCluster", "PS3.15");
  static const kdicomAssociationInitiator = const WKUid(
      "1.2.840.10008.15.0.3.10", UidType.kLdapOid, false, "dicomAssociationInitiator", "PS3.15");
  static const kdicomAssociationAcceptor = const WKUid(
      "1.2.840.10008.15.0.3.11", UidType.kLdapOid, false, "dicomAssociationAcceptor", "PS3.15");
  static const kdicomHostname =
      const WKUid("1.2.840.10008.15.0.3.12", UidType.kLdapOid, false, "dicomHostname", "PS3.15");
  static const kdicomPort =
      const WKUid("1.2.840.10008.15.0.3.13", UidType.kLdapOid, false, "dicomPort", "PS3.15");
  static const kdicomSOPClass =
      const WKUid("1.2.840.10008.15.0.3.14", UidType.kLdapOid, false, "dicomSOPClass", "PS3.15");
  static const kdicomTransferRole = const WKUid(
      "1.2.840.10008.15.0.3.15", UidType.kLdapOid, false, "dicomTransferRole", "PS3.15");
  static const kdicomTransferSyntax = const WKUid(
      "1.2.840.10008.15.0.3.16", UidType.kLdapOid, false, "dicomTransferSyntax", "PS3.15");
  static const kdicomPrimaryDeviceType = const WKUid(
      "1.2.840.10008.15.0.3.17", UidType.kLdapOid, false, "dicomPrimaryDeviceType", "PS3.15");
  static const kdicomRelatedDeviceReference = const WKUid(
      "1.2.840.10008.15.0.3.18", UidType.kLdapOid, false, "dicomRelatedDeviceReference", "PS3.15");
  static const kdicomPreferredCalledAETitle = const WKUid(
      "1.2.840.10008.15.0.3.19", UidType.kLdapOid, false, "dicomPreferredCalledAETitle", "PS3.15");
  static const kdicomTLSCyphersuite = const WKUid(
      "1.2.840.10008.15.0.3.20", UidType.kLdapOid, false, "dicomTLSCyphersuite", "PS3.15");
  static const kdicomAuthorizedNodeCertificateReference = const WKUid("1.2.840.10008.15.0.3.21",
      UidType.kLdapOid, false, "dicomAuthorizedNodeCertificateReference", "PS3.15");
  static const kdicomThisNodeCertificateReference = const WKUid("1.2.840.10008.15.0.3.22",
      UidType.kLdapOid, false, "dicomThisNodeCertificateReference", "PS3.15");
  static const kdicomInstalled =
      const WKUid("1.2.840.10008.15.0.3.23", UidType.kLdapOid, false, "dicomInstalled", "PS3.15");
  static const kdicomStationName =
      const WKUid("1.2.840.10008.15.0.3.24", UidType.kLdapOid, false, "dicomStationName", "PS3.15");
  static const kdicomDeviceSerialNumber = const WKUid(
      "1.2.840.10008.15.0.3.25", UidType.kLdapOid, false, "dicomDeviceSerialNumber", "PS3.15");
  static const kdicomInstitutionName = const WKUid(
      "1.2.840.10008.15.0.3.26", UidType.kLdapOid, false, "dicomInstitutionName", "PS3.15");
  static const kdicomInstitutionAddress = const WKUid(
      "1.2.840.10008.15.0.3.27", UidType.kLdapOid, false, "dicomInstitutionAddress", "PS3.15");
  static const kdicomInstitutionDepartmentName = const WKUid("1.2.840.10008.15.0.3.28",
      UidType.kLdapOid, false, "dicomInstitutionDepartmentName", "PS3.15");
  static const kdicomIssuerOfPatientID = const WKUid(
      "1.2.840.10008.15.0.3.29", UidType.kLdapOid, false, "dicomIssuerOfPatientID", "PS3.15");
  static const kdicomPreferredCallingAETitle = const WKUid(
      "1.2.840.10008.15.0.3.30", UidType.kLdapOid, false, "dicomPreferredCallingAETitle", "PS3.15");
  static const kdicomSupportedCharacterSet = const WKUid(
      "1.2.840.10008.15.0.3.31", UidType.kLdapOid, false, "dicomSupportedCharacterSet", "PS3.15");
  static const kdicomConfigurationRoot = const WKUid(
      "1.2.840.10008.15.0.4.1", UidType.kLdapOid, false, "dicomConfigurationRoot", "PS3.15");
  static const kdicomDevicesRoot =
      const WKUid("1.2.840.10008.15.0.4.2", UidType.kLdapOid, false, "dicomDevicesRoot", "PS3.15");
  static const kdicomUniqueAETitlesRegistryRoot = const WKUid("1.2.840.10008.15.0.4.3",
      UidType.kLdapOid, false, "dicomUniqueAETitlesRegistryRoot", "PS3.15");
  static const kdicomDevice =
      const WKUid("1.2.840.10008.15.0.4.4", UidType.kLdapOid, false, "dicomDevice", "PS3.15");
  static const kdicomNetworkAE =
      const WKUid("1.2.840.10008.15.0.4.5", UidType.kLdapOid, false, "dicomNetworkAE", "PS3.15");
  static const kdicomNetworkConnection = const WKUid(
      "1.2.840.10008.15.0.4.6", UidType.kLdapOid, false, "dicomNetworkConnection", "PS3.15");
  static const kdicomUniqueAETitle = const WKUid(
      "1.2.840.10008.15.0.4.7", UidType.kLdapOid, false, "dicomUniqueAETitle", "PS3.15");
  static const kdicomTransferCapability = const WKUid(
      "1.2.840.10008.15.0.4.8", UidType.kLdapOid, false, "dicomTransferCapability", "PS3.15");
  static const kUniversalCoordinatedTime = const WKUid("1.2.840.10008.15.1.1",
      UidType.kSynchronizationFrameOfReference, false, "Universal Coordinated Time", "PS3.3");
}
