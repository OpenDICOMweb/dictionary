...
import 'private_creators_map.dart';
...
class PrivateCreatorTag extends Tag {
  ...
  PrivateCreatorTag(code, this.token, this.dataTags)
  ...
  const PrivateCreatorTag._(code, this.token, this.dataTags)
      : super(code, VR.kLO, VM.k1);
  ...
  static Map<int, PrivateDataTag> lookup(String creatorToken, [int code]) =>
      privateCreatorsMap[creatorToken];
}
