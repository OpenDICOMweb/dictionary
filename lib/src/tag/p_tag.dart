...
import 'package:dictionary/src/tag/p_tag_keywords.dart';
...
*/
  ...
  static const PTag kRecognitionCode
      //(0008,0010)
      = const PTag._("RecognitionCode", 0x00080010, "Recognition Code", VR.kSH,
          VM.k1, true);
  ...
  static const PTag kSOPInstanceUID
      //(0008,0018)
      = const PTag._("SOPInstanceUID", 0x00080018, "SOP Instance UID", VR.kUI,
          VM.k1, false);
  ...
  static const PTag kAcquisitionDate
      //(0008,0022)
      = const PTag._("AcquisitionDate", 0x00080022, "Acquisition Date", VR.kDA,
          VM.k1, false);
  ...
  static const PTag kAcquisitionTime
      //(0008,0032)
      = const PTag._("AcquisitionTime", 0x00080032, "Acquisition Time", VR.kTM,
          VM.k1, false);
  ...
  static const PTag kDataSetSubtype
      //(0008,0041)
      = const PTag._("DataSetSubtype", 0x00080041, "Data Set Subtype", VR.kLO,
          VM.k1, true);
  ...
  static const PTag kAccessionNumber
      //(0008,0050)
      = const PTag._("AccessionNumber", 0x00080050, "Accession Number", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kRetrieveAETitle
      //(0008,0054)
      = const PTag._("RetrieveAETitle", 0x00080054, "Retrieve AE Title", VR.kAE,
          VM.k1_n, false);
  ...
  static const PTag kConversionType
      //(0008,0064)
      = const PTag._("ConversionType", 0x00080064, "Conversion Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kInstitutionName
      //(0008,0080)
      = const PTag._("InstitutionName", 0x00080080, "Institution Name", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kMappingResource
      //(0008,0105)
      = const PTag._("MappingResource", 0x00080105, "Mapping Resource", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kCodingSchemeUID
      //(0008,010C)
      = const PTag._("CodingSchemeUID", 0x0008010C, "Coding Scheme UID", VR.kUI,
          VM.k1, false);
  ...
  static const PTag kOperatorsName
      //(0008,1070)
      = const PTag._("OperatorsName", 0x00081070, "Operators' Name", VR.kPN,
          VM.k1_n, false);
  ...
  static const PTag kSimpleFrameList
      //(0008,1161)
      = const PTag._("SimpleFrameList", 0x00081161, "Simple Frame List", VR.kUL,
          VM.k1_n, false);
  ...
  static const PTag kNumberOfStages
      //(0008,2124)
      = const PTag._("NumberOfStages", 0x00082124, "Number of Stages", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kEventTimeOffset
      //(0008,2134)
      = const PTag._("EventTimeOffset", 0x00082134, "Event Time Offset", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kPatientWeight
      //(0010,1030)
      = const PTag._("PatientWeight", 0x00101030, "Patient's Weight", VR.kDS,
          VM.k1, false);
  static const PTag kPatientAddress
      //(0010,1040)
      = const PTag._("PatientAddress", 0x00101040, "Patient's Address", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kBranchOfService
      //(0010,1081)
      = const PTag._("BranchOfService", 0x00101081, "Branch of Service", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kMedicalAlerts
      //(0010,2000)
      = const PTag._("MedicalAlerts", 0x00102000, "Medical Alerts", VR.kLO,
          VM.k1_n, false);
  ...
  static const PTag kPregnancyStatus
      //(0010,21C0)
      = const PTag._("PregnancyStatus", 0x001021C0, "Pregnancy Status", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kPatientSexNeutered
      //(0010,2203)
      = const PTag._("PatientSexNeutered", 0x00102203, "Patient's Sex Neutered",
          VR.kCS, VM.k1, false);
  ...
  static const PTag kPatientComments
      //(0010,4000)
      = const PTag._("PatientComments", 0x00104000, "Patient Comments", VR.kLT,
          VM.k1, false);
  ...
  static const PTag kCADFileFormat
      //(0014,0023)
      = const PTag._("CADFileFormat", 0x00140023, "CAD File Format", VR.kST,
          VM.k1_n, true);
  ...
  static const PTag kMaterialGrade
      //(0014,0042)
      = const PTag._("MaterialGrade", 0x00140042, "Material Grade", VR.kST,
          VM.k1_n, false);
  ...
  static const PTag kComponentShape
      //(0014,0050)
      = const PTag._("ComponentShape", 0x00140050, "Component Shape", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kEvaluatorNumber
      //(0014,2004)
      = const PTag._("EvaluatorNumber", 0x00142004, "Evaluator Number", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kIndicationLabel
      //(0014,2016)
      = const PTag._("IndicationLabel", 0x00142016, "Indication Label", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kIndicationType
      //(0014,201A)
      = const PTag._("IndicationType", 0x0014201A, "Indication Type", VR.kCS,
          VM.k1_n, false);
  ...
  static const PTag kModulationType
      //(0014,4026)
      = const PTag._("ModulationType", 0x00144026, "Modulation Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kDACGainPoints
      //(0014,4038)
      = const PTag._("DACGainPoints", 0x00144038, "DAC Gain Points", VR.kDS,
          VM.k1_n, false);
  static const PTag kDACTimePoints
      //(0014,403A)
      = const PTag._("DACTimePoints", 0x0014403A, "DAC Time Points", VR.kDS,
          VM.k1_n, false);
  ...
  static const PTag kCouplingMedium
      //(0014,4056)
      = const PTag._("CouplingMedium", 0x00144056, "Coupling Medium", VR.kST,
          VM.k1, false);
  ...
  static const PTag kSoundPathLength
      //(0014,405A)
      = const PTag._("SoundPathLength", 0x0014405A, "Sound Path Length", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kVelocityOfSound
      //(0014,4064)
      = const PTag._("VelocityOfSound", 0x00144064, "Velocity of Sound", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kCalibrationTime
      //(0014,407C)
      = const PTag._("CalibrationTime", 0x0014407C, "Calibration Time", VR.kTM,
          VM.k1_n, false);
  static const PTag kCalibrationDate
      //(0014,407E)
      = const PTag._("CalibrationDate", 0x0014407E, "Calibration Date", VR.kDA,
          VM.k1_n, false);
  ...
  static const PTag kProbeDriveNotes
      //(0014,4082)
      = const PTag._("ProbeDriveNotes", 0x00144082, "Probe Drive Notes", VR.kLT,
          VM.k1, false);
  ...
  static const PTag kProbeInductance
      //(0014,4084)
      = const PTag._("ProbeInductance", 0x00144084, "Probe Inductance", VR.kDS,
          VM.k1, false);
  static const PTag kProbeResistance
      //(0014,4085)
      = const PTag._("ProbeResistance", 0x00144085, "Probe Resistance", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kBridgeResistors
      //(0014,4088)
      = const PTag._("BridgeResistors", 0x00144088, "Bridge Resistors", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kChannelOverlap
      //(0014,409F)
      = const PTag._("ChannelOverlap", 0x0014409F, "Channel Overlap", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kSequenceVariant
      //(0018,0021)
      = const PTag._("SequenceVariant", 0x00180021, "Sequence Variant", VR.kCS,
          VM.k1_n, false);
  ...
  static const PTag kSliceThickness
      //(0018,0050)
      = const PTag._("SliceThickness", 0x00180050, "Slice Thickness", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kRepetitionTime
      //(0018,0080)
      = const PTag._("RepetitionTime", 0x00180080, "Repetition Time", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kEchoTrainLength
      //(0018,0091)
      = const PTag._("EchoTrainLength", 0x00180091, "Echo Train Length", VR.kIS,
          VM.k1, false);
  static const PTag kPercentSampling
      //(0018,0093)
      = const PTag._("PercentSampling", 0x00180093, "Percent Sampling", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kPixelBandwidth
      //(0018,0095)
      = const PTag._("PixelBandwidth", 0x00180095, "Pixel Bandwidth", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kNominalInterval
      //(0018,1062)
      = const PTag._("NominalInterval", 0x00181062, "Nominal Interval", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kFrameTimeVector
      //(0018,1065)
      = const PTag._("FrameTimeVector", 0x00181065, "Frame Time Vector", VR.kDS,
          VM.k1_n, false);
  ...
  static const PTag kAngularPosition
      //(0018,1141)
      = const PTag._("AngularPosition", 0x00181141, "Angular Position", VR.kDS,
          VM.k1, true);
  static const PTag kRadialPosition
      //(0018,1142)
      = const PTag._("RadialPosition", 0x00181142, "Radial Position", VR.kDS,
          VM.k1_n, false);
  ...
  static const PTag kRotationOffset
      //(0018,1146)
      = const PTag._("RotationOffset", 0x00181146, "Rotation Offset", VR.kDS,
          VM.k1_n, true);
  ...
  static const PTag kTypeOfFilters
      //(0018,1161)
      = const PTag._("TypeOfFilters", 0x00181161, "Type of Filters", VR.kLO,
          VM.k1_n, false);
  static const PTag kIntensifierSize
      //(0018,1162)
      = const PTag._("IntensifierSize", 0x00181162, "Intensifier Size", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kGeneratorPower
      //(0018,1170)
      = const PTag._("GeneratorPower", 0x00181170, "Generator Power", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kCollimatorType
      //(0018,1181)
      = const PTag._("CollimatorType", 0x00181181, "Collimator Type", VR.kCS,
          VM.k1, false);
  static const PTag kFocalDistance
      //(0018,1182)
      = const PTag._("FocalDistance", 0x00181182, "Focal Distance", VR.kIS,
          VM.k1_2, false);
  ...
  static const PTag kReceiveCoilName
      //(0018,1250)
      = const PTag._("ReceiveCoilName", 0x00181250, "Receive Coil Name", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kDeviationIndex
      //(0018,1413)
      = const PTag._("DeviationIndex", 0x00181413, "Deviation Index", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kTomoLayerHeight
      //(0018,1460)
      = const PTag._("TomoLayerHeight", 0x00181460, "Tomo Layer Height", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kPositionerType
      //(0018,1508)
      = const PTag._("PositionerType", 0x00181508, "Positioner Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kCollimatorShape
      //(0018,1700)
      = const PTag._("CollimatorShape", 0x00181700, "Collimator Shape", VR.kCS,
          VM.k1_3, false);
  ...
  static const PTag kDisplayedZValue
      //(0018,2046)
      = const PTag._("DisplayedZValue", 0x00182046, "Displayed Z Value", VR.kFL,
          VM.k1, false);
  static const PTag kIVUSAcquisition
      //(0018,3100)
      = const PTag._("IVUSAcquisition", 0x00183100, "IVUS Acquisition", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kTransducerData
      //(0018,5010)
      = const PTag._("TransducerData", 0x00185010, "Transducer Data", VR.kLO,
          VM.k1_n, false);
  ...
  static const PTag kMechanicalIndex
      //(0018,5022)
      = const PTag._("MechanicalIndex", 0x00185022, "Mechanical Index", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kPatientPosition
      //(0018,5100)
      = const PTag._("PatientPosition", 0x00185100, "Patient Position", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kRegionDataType
      //(0018,6014)
      = const PTag._("RegionDataType", 0x00186014, "Region Data Type", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kPhysicalDeltaX
      //(0018,602C)
      = const PTag._("PhysicalDeltaX", 0x0018602C, "Physical Delta X", VR.kFD,
          VM.k1, false);
  static const PTag kPhysicalDeltaY
      //(0018,602E)
      = const PTag._("PhysicalDeltaY", 0x0018602E, "Physical Delta Y", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kTransducerType
      //(0018,6031)
      = const PTag._("TransducerType", 0x00186031, "Transducer Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kDetectorBinning
      //(0018,701A)
      = const PTag._("DetectorBinning", 0x0018701A, "Detector Binning", VR.kDS,
          VM.k2, false);
  ...
  static const PTag kGridAspectRatio
      //(0018,7046)
      = const PTag._("GridAspectRatio", 0x00187046, "Grid Aspect Ratio", VR.kIS,
          VM.k2, false);
  ...
  static const PTag kFilterMaterial
      //(0018,7050)
      = const PTag._("FilterMaterial", 0x00187050, "Filter Material", VR.kCS,
          VM.k1_n, false);
  ...
  static const PTag kExposureStatus
      //(0018,7064)
      = const PTag._("ExposureStatus", 0x00187064, "Exposure Status", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kReceiveCoilType
      //(0018,9043)
      = const PTag._("ReceiveCoilType", 0x00189043, "Receive Coil Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kSpectralWidth
      //(0018,9052)
      = const PTag._("SpectralWidth", 0x00189052, "Spectral Width", VR.kFD,
          VM.k1_2, false);
  ...
  static const PTag kKSpaceFiltering
      //(0018,9064)
      = const PTag._("KSpaceFiltering", 0x00189064, "k-space Filtering", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kInversionTimes
      //(0018,9079)
      = const PTag._("InversionTimes", 0x00189079, "Inversion Times", VR.kFD,
          VM.k1_n, false);
  ...
  static const PTag kPartialFourier
      //(0018,9081)
      = const PTag._("PartialFourier", 0x00189081, "Partial Fourier", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kDiffusionBValue
      //(0018,9087)
      = const PTag._("DiffusionBValue", 0x00189087, "Diffusion b-value", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kResonantNucleus
      //(0018,9100)
      = const PTag._("ResonantNucleus", 0x00189100, "Resonant Nucleus", VR.kCS,
          VM.k1_2, false);
  ...
  static const PTag kSlabOrientation
      //(0018,9105)
      = const PTag._("SlabOrientation", 0x00189105, "Slab Orientation", VR.kFD,
          VM.k3, false);
  static const PTag kMidSlabPosition
      //(0018,9106)
      = const PTag._("MidSlabPosition", 0x00189106, "Mid Slab Position", VR.kFD,
          VM.k3, false);
  ...
  static const PTag kMREchoSequence
      //(0018,9114)
      = const PTag._("MREchoSequence", 0x00189114, "MR Echo Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kGradientOutput
      //(0018,9182)
      = const PTag._("GradientOutput", 0x00189182, "Gradient Output", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kASLCrusherFlag
      //(0018,9259)
      = const PTag._("ASLCrusherFlag", 0x00189259, "ASL Crusher Flag", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kASLSlabSequence
      //(0018,9260)
      = const PTag._("ASLSlabSequence", 0x00189260, "ASL Slab Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kAcquisitionType
      //(0018,9302)
      = const PTag._("AcquisitionType", 0x00189302, "Acquisition Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kRevolutionTime
      //(0018,9305)
      = const PTag._("RevolutionTime", 0x00189305, "Revolution Time", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kFluoroscopyFlag
      //(0018,9334)
      = const PTag._("FluoroscopyFlag", 0x00189334, "Fluoroscopy Flag", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kApplicationName
      //(0018,9524)
      = const PTag._("ApplicationName", 0x00189524, "Application Name", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kNumberOfSubsets
      //(0018,9740)
      = const PTag._("NumberOfSubsets", 0x00189740, "Number of Subsets", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kDecayCorrected
      //(0018,9758)
      = const PTag._("DecayCorrected", 0x00189758, "Decay Corrected", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kDepthsOfFocus
      //(0018,9801)
      = const PTag._("DepthsOfFocus", 0x00189801, "Depth(s) of Focus", VR.kFD,
          VM.k1_n, false);
  ...
  static const PTag kAliasedDataType
      //(0018,980B)
      = const PTag._("AliasedDataType", 0x0018980B, "Aliased Data Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kInstanceNumber
      //(0020,0013)
      = const PTag._("InstanceNumber", 0x00200013, "Instance Number", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kTimeSlotNumber
      //(0020,0017)
      = const PTag._("TimeSlotNumber", 0x00200017, "Time Slot Number", VR.kIS,
          VM.k1, true);
  ...
  static const PTag kImageLaterality
      //(0020,0062)
      = const PTag._("ImageLaterality", 0x00200062, "Image Laterality", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kImagesInSeries
      //(0020,1003)
      = const PTag._("ImagesInSeries", 0x00201003, "Images in Series", VR.kIS,
          VM.k1, true);
  ...
  static const PTag kSourceImageIDs
      //(0020,3100)
      = const PTag._("SourceImageIDs", 0x00203100, "Source Image IDs", VR.kCS,
          VM.k1_n, true);
  ...
  static const PTag kModifiedImageID
      //(0020,3402)
      = const PTag._("ModifiedImageID", 0x00203402, "Modified Image ID", VR.kCS,
          VM.k1, true);
  ...
  static const PTag kFrameLaterality
      //(0020,9072)
      = const PTag._("FrameLaterality", 0x00209072, "Frame Laterality", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kStereoRotation
      //(0022,0014)
      = const PTag._("StereoRotation", 0x00220014, "Stereo Rotation", VR.kFL,
          VM.k1, false);
  ...
  static const PTag kIOLManufacturer
      //(0022,1093)
      = const PTag._("IOLManufacturer", 0x00221093, "IOL Manufacturer", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kStimulusResults
      //(0024,0093)
      = const PTag._("StimulusResults", 0x00240093, "Stimulus Results", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kAlgorithmSource
      //(0024,0202)
      = const PTag._("AlgorithmSource", 0x00240202, "Algorithm Source", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kDataSetVersion
      //(0024,0307)
      = const PTag._("DataSetVersion", 0x00240307, "Data Set Version", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kSamplesPerPixel
      //(0028,0002)
      = const PTag._("SamplesPerPixel", 0x00280002, "Samples per Pixel", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kImageDimensions
      //(0028,0005)
      = const PTag._("ImageDimensions", 0x00280005, "Image Dimensions", VR.kUS,
          VM.k1, true);
  ...
  static const PTag kNumberOfFrames
      //(0028,0008)
      = const PTag._("NumberOfFrames", 0x00280008, "Number of Frames", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kCorrectedImage
      //(0028,0051)
      = const PTag._("CorrectedImage", 0x00280051, "Corrected Image", VR.kCS,
          VM.k1_n, false);
  ...
  static const PTag kCompressionCode
      //(0028,0060)
      = const PTag._("CompressionCode", 0x00280060, "Compression Code", VR.kCS,
          VM.k1, true);
  ...
  static const PTag kPerimeterTable
      //(0028,0070)
      = const PTag._("PerimeterTable", 0x00280070, "Perimeter Table", VR.kUS,
          VM.k1_n, true);
  static const PTag kPerimeterValue
      //(0028,0071)
      = const PTag._("PerimeterValue", 0x00280071, "Perimeter Value", VR.kUSSS,
          VM.k1, true);
  ...
  static const PTag kZonalMapFormat
      //(0028,0722)
      = const PTag._("ZonalMapFormat", 0x00280722, "Zonal Map Format", VR.kUS,
          VM.k1, true);
  ...
  static const PTag kNumberOfTables
      //(0028,0802)
      = const PTag._("NumberOfTables", 0x00280802, "Number of Tables", VR.kUS,
          VM.k1, true);
  ...
  static const PTag kVOILUTFunction
      //(0028,1056)
      = const PTag._("VOILUTFunction", 0x00281056, "VOI LUT Function", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kModalityLUTType
      //(0028,3004)
      = const PTag._("ModalityLUTType", 0x00283004, "Modality LUT Type", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kLUTFrameRange
      //(0028,9507)
      = const PTag._("LUTFrameRange", 0x00289507, "LUT Frame Range", VR.kUS,
          VM.k2_2n, false);
  ...
  static const PTag kStudyPriorityID
      //(0032,000C)
      = const PTag._("StudyPriorityID", 0x0032000C, "Study Priority ID", VR.kCS,
          VM.k1, true);
  ...
  static const PTag kReasonForStudy
      //(0032,1030)
      = const PTag._("ReasonForStudy", 0x00321030, "Reason for Study", VR.kLO,
          VM.k1, true);
  ...
  static const PTag kChannelStatus
      //(003A,0205)
      = const PTag._("ChannelStatus", 0x003A0205, "Channel Status", VR.kCS,
          VM.k1_n, false);
  ...
  static const PTag kChannelBaseline
      //(003A,0213)
      = const PTag._("ChannelBaseline", 0x003A0213, "Channel Baseline", VR.kDS,
          VM.k1, false);
  static const PTag kChannelTimeSkew
      //(003A,0214)
      = const PTag._("ChannelTimeSkew", 0x003A0214, "Channel Time Skew", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kChannelPosition
      //(003A,0245)
      = const PTag._("ChannelPosition", 0x003A0245, "Channel Position", VR.kFL,
          VM.k1, false);
  ...
  static const PTag kHalfValueLayer
      //(0040,0314)
      = const PTag._("HalfValueLayer", 0x00400314, "Half Value Layer", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kSlideIdentifier
      //(0040,06FA)
      = const PTag._("SlideIdentifier", 0x004006FA, "Slide Identifier", VR.kLO,
          VM.k1, true);
  ...
  static const PTag kPersonAddress
      //(0040,1102)
      = const PTag._("PersonAddress", 0x00401102, "Person's Address", VR.kST,
          VM.k1, false);
  ...
  static const PTag kOrderEnteredBy
      //(0040,2008)
      = const PTag._("OrderEnteredBy", 0x00402008, "Order Entered By", VR.kPN,
          VM.k1, false);
  ...
  static const PTag kHumanPerformerName
      //(0040,4037)
      = const PTag._("HumanPerformerName", 0x00404037, "Human Performer's Name",
          VR.kPN, VM.k1, false);
  static const PTag kRawDataHandling
      //(0040,4040)
      = const PTag._("RawDataHandling", 0x00404040, "Raw Data Handling", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kObservationUID
      //(0040,A171)
      = const PTag._("ObservationUID", 0x0040A171, "Observation UID", VR.kUI,
          VM.k1, false);
  ...
  static const PTag kCompletionFlag
      //(0040,A491)
      = const PTag._("CompletionFlag", 0x0040A491, "Completion Flag", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kPreliminaryFlag
      //(0040,A496)
      = const PTag._("PreliminaryFlag", 0x0040A496, "Preliminary Flag", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kContentSequence
      //(0040,A730)
      = const PTag._("ContentSequence", 0x0040A730, "Content Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kTemplateVersion
      //(0040,DB06)
      = const PTag._("TemplateVersion", 0x0040DB06, "Template Version", VR.kDT,
          VM.k1, true);
  ...
  static const PTag kTypeOfInstances
      //(0040,E020)
      = const PTag._("TypeOfInstances", 0x0040E020, "Type of Instances", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kHomeCommunityID
      //(0040,E031)
      = const PTag._("HomeCommunityID", 0x0040E031, "Home Community ID", VR.kUI,
          VM.k1, false);
  ...
  static const PTag kLensDescription
      //(0046,0012)
      = const PTag._("LensDescription", 0x00460012, "Lens Description", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kLensSegmentType
      //(0046,0038)
      = const PTag._("LensSegmentType", 0x00460038, "Lens Segment Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kBackgroundColor
      //(0046,0092)
      = const PTag._("BackgroundColor", 0x00460092, "Background Color", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kAddNearSequence
      //(0046,0100)
      = const PTag._("AddNearSequence", 0x00460100, "Add Near Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kViewingDistance
      //(0046,0106)
      = const PTag._("ViewingDistance", 0x00460106, "Viewing Distance", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kCornealISValue
      //(0046,0224)
      = const PTag._("CornealISValue", 0x00460224, "Corneal I-S Value", VR.kFL,
          VM.k1, false);
  ...
  static const PTag kTangentialPower
      //(0046,0250)
      = const PTag._("TangentialPower", 0x00460250, "Tangential Power", VR.kFL,
          VM.k1, false);
  static const PTag kRefractivePower
      //(0046,0251)
      = const PTag._("RefractivePower", 0x00460251, "Refractive Power", VR.kFL,
          VM.k1, false);
  ...
  static const PTag kDeviceSequence
      //(0050,0010)
      = const PTag._("DeviceSequence", 0x00500010, "Device Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kDeviceDiameter
      //(0050,0016)
      = const PTag._("DeviceDiameter", 0x00500016, "Device Diameter", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kAxialResolution
      //(0052,0008)
      = const PTag._("AxialResolution", 0x00520008, "Axial Resolution", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kALinesPerFrame
      //(0052,0012)
      = const PTag._("ALinesPerFrame", 0x00520012, "A-lines Per Frame", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kDetectorVector
      //(0054,0020)
      = const PTag._("DetectorVector", 0x00540020, "Detector Vector", VR.kUS,
          VM.k1_n, false);
  ...
  static const PTag kNumberOfPhases
      //(0054,0031)
      = const PTag._("NumberOfPhases", 0x00540031, "Number of Phases", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kRotationVector
      //(0054,0050)
      = const PTag._("RotationVector", 0x00540050, "Rotation Vector", VR.kUS,
          VM.k1_n, false);
  ...
  static const PTag kTimeSlotVector
      //(0054,0070)
      = const PTag._("TimeSlotVector", 0x00540070, "Time Slot Vector", VR.kUS,
          VM.k1_n, false);
  ...
  static const PTag kNumberOfSlices
      //(0054,0081)
      = const PTag._("NumberOfSlices", 0x00540081, "Number of Slices", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kTimeSliceVector
      //(0054,0100)
      = const PTag._("TimeSliceVector", 0x00540100, "Time Slice Vector", VR.kUS,
          VM.k1_n, false);
  ...
  static const PTag kTriggerVector
      //(0054,0210)
      = const PTag._("TriggerVector", 0x00540210, "Trigger Vector", VR.kIS,
          VM.k1_n, false);
  ...
  static const PTag kDecayCorrection
      //(0054,1102)
      = const PTag._("DecayCorrection", 0x00541102, "Decay Correction", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kAxialAcceptance
      //(0054,1200)
      = const PTag._("AxialAcceptance", 0x00541200, "Axial Acceptance", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kTransverseMash
      //(0054,1202)
      = const PTag._("TransverseMash", 0x00541202, "Transverse Mash", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kDeadTimeFactor
      //(0054,1324)
      = const PTag._("DeadTimeFactor", 0x00541324, "Dead Time Factor", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kCountsIncluded
      //(0054,1400)
      = const PTag._("CountsIncluded", 0x00541400, "Counts Included", VR.kCS,
          VM.k1_n, true);
  ...
  static const PTag kHistogramData
      //(0060,3020)
      = const PTag._("HistogramData", 0x00603020, "Histogram Data", VR.kUL,
          VM.k1_n, false);
  ...
  static const PTag kSegmentSequence
      //(0062,0002)
      = const PTag._("SegmentSequence", 0x00620002, "Segment Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kGridDimensions
      //(0064,0007)
      = const PTag._("GridDimensions", 0x00640007, "Grid Dimensions", VR.kUL,
          VM.k3, false);
  static const PTag kGridResolution
      //(0064,0008)
      = const PTag._("GridResolution", 0x00640008, "Grid Resolution", VR.kFD,
          VM.k3, false);
  static const PTag kVectorGridData
      //(0064,0009)
      = const PTag._("VectorGridData", 0x00640009, "Vector Grid Data", VR.kOF,
          VM.k1, false);
  ...
  static const PTag kSurfaceSequence
      //(0066,0002)
      = const PTag._("SurfaceSequence", 0x00660002, "Surface Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kSurfaceComments
      //(0066,0004)
      = const PTag._("SurfaceComments", 0x00660004, "Surface Comments", VR.kLT,
          VM.k1, false);
  ...
  static const PTag kAxisOfRotation
      //(0066,001B)
      = const PTag._("AxisOfRotation", 0x0066001B, "Axis of Rotation", VR.kFL,
          VM.k3, false);
  ...
  static const PTag kNumberOfVectors
      //(0066,001E)
      = const PTag._("NumberOfVectors", 0x0066001E, "Number of Vectors", VR.kUL,
          VM.k1, false);
  ...
  static const PTag kVectorAccuracy
      //(0066,0020)
      = const PTag._("VectorAccuracy", 0x00660020, "Vector Accuracy", VR.kFL,
          VM.k1_n, false);
  ...
  static const PTag kHPGLDocumentID
      //(0068,62D0)
      = const PTag._("HPGLDocumentID", 0x006862D0, "HPGL Document ID", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kHPGLPenSequence
      //(0068,6320)
      = const PTag._("HPGLPenSequence", 0x00686320, "HPGL Pen Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kMatingFeatureID
      //(0068,63F0)
      = const PTag._("MatingFeatureID", 0x006863F0, "Mating Feature ID", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kTwoDMatingPoint
      //(0068,6450)
      = const PTag._("TwoDMatingPoint", 0x00686450, "2D Mating Point", VR.kFD,
          VM.k2, false);
  ...
  static const PTag kRangeOfFreedom
      //(0068,64A0)
      = const PTag._("RangeOfFreedom", 0x006864A0, "Range of Freedom", VR.kFD,
          VM.k2, false);
  static const PTag kThreeDMatingPoint
      //(0068,64C0)
      = const PTag._("ThreeDMatingPoint", 0x006864C0, "3D Mating Point", VR.kFD,
          VM.k3, false);
  static const PTag kThreeDMatingAxes
      //(0068,64D0)
      = const PTag._("ThreeDMatingAxes", 0x006864D0, "3D Mating Axes", VR.kFD,
          VM.k9, false);
  ...
  static const PTag kThreeDPlaneOrigin
      //(0068,6610)
      = const PTag._("ThreeDPlaneOrigin", 0x00686610, "3D Plane Origin", VR.kFD,
          VM.k3, false);
  static const PTag kThreeDPlaneNormal
      //(0068,6620)
      = const PTag._("ThreeDPlaneNormal", 0x00686620, "3D Plane Normal", VR.kFD,
          VM.k3, false);
  ...
  static const PTag kContentCreatorName
      //(0070,0084)
      = const PTag._("ContentCreatorName", 0x00700084, "Content Creator's Name",
          VR.kPN, VM.k1, false);
  ...
  static const PTag kGraphicGroupID
      //(0070,0295)
      = const PTag._("GraphicGroupID", 0x00700295, "Graphic Group ID", VR.kUL,
          VM.k1, false);
  ...
  static const PTag kMatrixSequence
      //(0070,030A)
      = const PTag._("MatrixSequence", 0x0070030A, "Matrix Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kRelativeOpacity
      //(0070,0403)
      = const PTag._("RelativeOpacity", 0x00700403, "Relative Opacity", VR.kFL,
          VM.k1, false);
  ...
  static const PTag kImageSetNumber
      //(0072,0032)
      = const PTag._("ImageSetNumber", 0x00720032, "Image Set Number", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kSelectorATValue
      //(0072,0060)
      = const PTag._("SelectorATValue", 0x00720060, "Selector AT Value", VR.kAT,
          VM.k1_n, false);
  static const PTag kSelectorCSValue
      //(0072,0062)
      = const PTag._("SelectorCSValue", 0x00720062, "Selector CS Value", VR.kCS,
          VM.k1_n, false);
  static const PTag kSelectorISValue
      //(0072,0064)
      = const PTag._("SelectorISValue", 0x00720064, "Selector IS Value", VR.kIS,
          VM.k1_n, false);
  static const PTag kSelectorLOValue
      //(0072,0066)
      = const PTag._("SelectorLOValue", 0x00720066, "Selector LO Value", VR.kLO,
          VM.k1_n, false);
  static const PTag kSelectorLTValue
      //(0072,0068)
      = const PTag._("SelectorLTValue", 0x00720068, "Selector LT Value", VR.kLT,
          VM.k1, false);
  static const PTag kSelectorPNValue
      //(0072,006A)
      = const PTag._("SelectorPNValue", 0x0072006A, "Selector PN Value", VR.kPN,
          VM.k1_n, false);
  static const PTag kSelectorSHValue
      //(0072,006C)
      = const PTag._("SelectorSHValue", 0x0072006C, "Selector SH Value", VR.kSH,
          VM.k1_n, false);
  static const PTag kSelectorSTValue
      //(0072,006E)
      = const PTag._("SelectorSTValue", 0x0072006E, "Selector ST Value", VR.kST,
          VM.k1, false);
  static const PTag kSelectorUTValue
      //(0072,0070)
      = const PTag._("SelectorUTValue", 0x00720070, "Selector UT Value", VR.kUT,
          VM.k1, false);
  static const PTag kSelectorDSValue
      //(0072,0072)
      = const PTag._("SelectorDSValue", 0x00720072, "Selector DS Value", VR.kDS,
          VM.k1_n, false);
  static const PTag kSelectorODValue
      //(0072,0073)
      = const PTag._("SelectorODValue", 0x00720073, "Selector OD Value", VR.kOD,
          VM.k1, false);
  static const PTag kSelectorFDValue
      //(0072,0074)
      = const PTag._("SelectorFDValue", 0x00720074, "Selector FD Value", VR.kFD,
          VM.k1_n, false);
  static const PTag kSelectorFLValue
      //(0072,0076)
      = const PTag._("SelectorFLValue", 0x00720076, "Selector FL Value", VR.kFL,
          VM.k1_n, false);
  static const PTag kSelectorULValue
      //(0072,0078)
      = const PTag._("SelectorULValue", 0x00720078, "Selector UL Value", VR.kUL,
          VM.k1_n, false);
  static const PTag kSelectorUSValue
      //(0072,007A)
      = const PTag._("SelectorUSValue", 0x0072007A, "Selector US Value", VR.kUS,
          VM.k1_n, false);
  static const PTag kSelectorSLValue
      //(0072,007C)
      = const PTag._("SelectorSLValue", 0x0072007C, "Selector SL Value", VR.kSL,
          VM.k1_n, false);
  static const PTag kSelectorSSValue
      //(0072,007E)
      = const PTag._("SelectorSSValue", 0x0072007E, "Selector SS Value", VR.kSS,
          VM.k1_n, false);
  ...
  static const PTag kNumberOfScreens
      //(0072,0100)
      = const PTag._("NumberOfScreens", 0x00720100, "Number of Screens", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kDisplaySetLabel
      //(0072,0203)
      = const PTag._("DisplaySetLabel", 0x00720203, "Display Set Label", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kImageBoxNumber
      //(0072,0302)
      = const PTag._("ImageBoxNumber", 0x00720302, "Image Box Number", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kSortByCategory
      //(0072,0602)
      = const PTag._("SortByCategory", 0x00720602, "Sort-by Category", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kPseudoColorType
      //(0072,0704)
      = const PTag._("PseudoColorType", 0x00720704, "Pseudo-Color Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kBeamOrderIndex
      //(0074,1324)
      = const PTag._("BeamOrderIndex", 0x00741324, "Beam Order Index", VR.kUL,
          VM.k1, false);
  ...
  static const PTag kShotOffsetTime
      //(0080,0005)
      = const PTag._("ShotOffsetTime", 0x00800005, "Shot Offset Time", VR.kFD,
          VM.k1, false);
  ...
  static const PTag kTopicKeywords
      //(0088,0912)
      = const PTag._("TopicKeywords", 0x00880912, "Topic Keywords", VR.kLO,
          VM.k1_32, true);
  ...
  static const PTag kCertificateType
      //(0400,0110)
      = const PTag._("CertificateType", 0x04000110, "Certificate Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kModifyingSystem
      //(0400,0563)
      = const PTag._("ModifyingSystem", 0x04000563, "Modifying System", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kShiftTableSize
      //(1000,0004)
      = const PTag._("ShiftTableSize", 0x10000004, "Shift Table Size", VR.kUS,
          VM.k1, true);
  ...
  static const PTag kNumberOfCopies
      //(2000,0010)
      = const PTag._("NumberOfCopies", 0x20000010, "Number of Copies", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kFilmDestination
      //(2000,0040)
      = const PTag._("FilmDestination", 0x20000040, "Film Destination", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kMemoryBitDepth
      //(2000,00A0)
      = const PTag._("MemoryBitDepth", 0x200000A0, "Memory Bit Depth", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kFilmOrientation
      //(2010,0040)
      = const PTag._("FilmOrientation", 0x20100040, "Film Orientation", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kExecutionStatus
      //(2100,0020)
      = const PTag._("ExecutionStatus", 0x21000020, "Execution Status", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kRequestPriority
      //(2200,0020)
      = const PTag._("RequestPriority", 0x22000020, "Request Priority", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kRTImagePosition
      //(3002,0012)
      = const PTag._("RTImagePosition", 0x30020012, "RT Image Position", VR.kDS,
          VM.k2, false);
  ...
  static const PTag kFractionNumber
      //(3002,0029)
      = const PTag._("FractionNumber", 0x30020029, "Fraction Number", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kDoseGridScaling
      //(3004,000E)
      = const PTag._("DoseGridScaling", 0x3004000E, "Dose Grid Scaling", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kDVHDoseScaling
      //(3004,0052)
      = const PTag._("DVHDoseScaling", 0x30040052, "DVH Dose Scaling", VR.kDS,
          VM.k1, false);
  static const PTag kDVHVolumeUnits
      //(3004,0054)
      = const PTag._("DVHVolumeUnits", 0x30040054, "DVH Volume Units", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kDVHMinimumDose
      //(3004,0070)
      = const PTag._("DVHMinimumDose", 0x30040070, "DVH Minimum Dose", VR.kDS,
          VM.k1, false);
  static const PTag kDVHMaximumDose
      //(3004,0072)
      = const PTag._("DVHMaximumDose", 0x30040072, "DVH Maximum Dose", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kROIDescription
      //(3006,0028)
      = const PTag._("ROIDescription", 0x30060028, "ROI Description", VR.kST,
          VM.k1, false);
  static const PTag kROIDisplayColor
      //(3006,002A)
      = const PTag._("ROIDisplayColor", 0x3006002A, "ROI Display Color", VR.kIS,
          VM.k3, false);
  ...
  static const PTag kContourSequence
      //(3006,0040)
      = const PTag._("ContourSequence", 0x30060040, "Contour Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kROIInterpreter
      //(3006,00A6)
      = const PTag._("ROIInterpreter", 0x300600A6, "ROI Interpreter", VR.kPN,
          VM.k1, false);
  ...
  static const PTag kMetersetRateSet
      //(3008,0045)
      = const PTag._("MetersetRateSet", 0x30080045, "Meterset Rate Set", VR.kFL,
          VM.k1, false);
  ...
  static const PTag kOverrideReason
      //(3008,0066)
      = const PTag._("OverrideReason", 0x30080066, "Override Reason", VR.kST,
          VM.k1, false);
  ...
  static const PTag kCorrectionValue
      //(3008,006A)
      = const PTag._("CorrectionValue", 0x3008006A, "Correction Value", VR.kFL,
          VM.k1, false);
  ...
  static const PTag kTreatmentSites
      //(300A,000B)
      = const PTag._("TreatmentSites", 0x300A000B, "Treatment Sites", VR.kLO,
          VM.k1_n, false);
  static const PTag kRTPlanGeometry
      //(300A,000C)
      = const PTag._("RTPlanGeometry", 0x300A000C, "RT Plan Geometry", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kFractionPattern
      //(300A,007B)
      = const PTag._("FractionPattern", 0x300A007B, "Fraction Pattern", VR.kLT,
          VM.k1, false);
  ...
  static const PTag kBeamDoseMeaning
      //(300A,008B)
      = const PTag._("BeamDoseMeaning", 0x300A008B, "Beam Dose Meaning", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kBeamDescription
      //(300A,00C3)
      = const PTag._("BeamDescription", 0x300A00C3, "Beam Description", VR.kST,
          VM.k1, false);
  ...
  static const PTag kNumberOfWedges
      //(300A,00D0)
      = const PTag._("NumberOfWedges", 0x300A00D0, "Number of Wedges", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kCompensatorRows
      //(300A,00E7)
      = const PTag._("CompensatorRows", 0x300A00E7, "Compensator Rows", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kCompensatorType
      //(300A,00EE)
      = const PTag._("CompensatorType", 0x300A00EE, "Compensator Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kNumberOfBlocks
      //(300A,00F0)
      = const PTag._("NumberOfBlocks", 0x300A00F0, "Number of Blocks", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kBlockDivergence
      //(300A,00FA)
      = const PTag._("BlockDivergence", 0x300A00FA, "Block Divergence", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kBlockThickness
      //(300A,0100)
      = const PTag._("BlockThickness", 0x300A0100, "Block Thickness", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kApplicatorType
      //(300A,0109)
      = const PTag._("ApplicatorType", 0x300A0109, "Applicator Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kSetupTechnique
      //(300A,01B0)
      = const PTag._("SetupTechnique", 0x300A01B0, "Setup Technique", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kSetupDeviceType
      //(300A,01B6)
      = const PTag._("SetupDeviceType", 0x300A01B6, "Setup Device Type", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kSourceSequence
      //(300A,0210)
      = const PTag._("SourceSequence", 0x300A0210, "Source Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kSourceStrength
      //(300A,022B)
      = const PTag._("SourceStrength", 0x300A022B, "Source Strength", VR.kDS,
          VM.k1, false);
  ...
  static const PTag kTemplateNumber
      //(300A,0240)
      = const PTag._("TemplateNumber", 0x300A0240, "Template Number", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kChannelSequence
      //(300A,0280)
      = const PTag._("ChannelSequence", 0x300A0280, "Channel Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kNumberOfPulses
      //(300A,028A)
      = const PTag._("NumberOfPulses", 0x300A028A, "Number of Pulses", VR.kIS,
          VM.k1, false);
  ...
  static const PTag kChannelShieldID
      //(300A,02B3)
      = const PTag._("ChannelShieldID", 0x300A02B3, "Channel Shield ID", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kRangeShifterID
      //(300A,0318)
      = const PTag._("RangeShifterID", 0x300A0318, "Range Shifter ID", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kScanSpotTuneID
      //(300A,0390)
      = const PTag._("ScanSpotTuneID", 0x300A0390, "Scan Spot Tune ID", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kIonBeamSequence
      //(300A,03A2)
      = const PTag._("IonBeamSequence", 0x300A03A2, "Ion Beam Sequence", VR.kSQ,
          VM.k1, false);
  ...
  static const PTag kApprovalStatus
      //(300E,0002)
      = const PTag._("ApprovalStatus", 0x300E0002, "Approval Status", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kResultsIDIssuer
      //(4008,0042)
      = const PTag._("ResultsIDIssuer", 0x40080042, "Results ID Issuer", VR.kLO,
          VM.k1, true);
  ...
  static const PTag kResultsComments
      //(4008,4000)
      = const PTag._("ResultsComments", 0x40084000, "Results Comments", VR.kST,
          VM.k1, true);
  ...
  static const PTag kThreatROIBitmap
      //(4010,1006)
      = const PTag._("ThreatROIBitmap", 0x40101006, "Threat ROI Bitmap", VR.kOB,
          VM.k1, false);
  static const PTag kRouteSegmentID
      //(4010,1007)
      = const PTag._("RouteSegmentID", 0x40101007, "Route Segment ID", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kThreatSequence
      //(4010,1011)
      = const PTag._("ThreatSequence", 0x40101011, "Threat Sequence", VR.kSQ,
          VM.k1, false);
  static const PTag kThreatCategory
      //(4010,1012)
      = const PTag._("ThreatCategory", 0x40101012, "Threat Category", VR.kCS,
          VM.k1, false);
  ...
  static const PTag kBoardingPassID
      //(4010,101A)
      = const PTag._("BoardingPassID", 0x4010101A, "Boarding Pass ID", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kBoundingPolygon
      //(4010,101D)
      = const PTag._("BoundingPolygon", 0x4010101D, "Bounding Polygon", VR.kFL,
          VM.k6_n, false);
  ...
  static const PTag kItineraryIDType
      //(4010,1052)
      = const PTag._("ItineraryIDType", 0x40101052, "Itinerary ID Type", VR.kSH,
          VM.k1, false);
  ...
  static const PTag kSourcePosition
      //(4010,1061)
      = const PTag._("SourcePosition", 0x40101061, "Source Position", VR.kFL,
          VM.k3, false);
  ...
  static const PTag kCurveDimensions
      //(5000,0005)
      = const PTag._("CurveDimensions", 0x50000005, "Curve Dimensions", VR.kUS,
          VM.k1, true);
  static const PTag kNumberOfPoints
      //(5000,0010)
      = const PTag._("NumberOfPoints", 0x50000010, "Number of Points", VR.kUS,
          VM.k1, true);
  ...
  static const PTag kNumberOfSamples
      //(5000,2006)
      = const PTag._("NumberOfSamples", 0x50002006, "Number of Samples", VR.kUL,
          VM.k1, true);
  ...
  static const PTag kOverlayColumns
      //(6000,0011)
      = const PTag._("OverlayColumns", 0x60000011, "Overlay Columns", VR.kUS,
          VM.k1, false);
  ...
  static const PTag kOverlaySubtype
      //(6000,0045)
      = const PTag._("OverlaySubtype", 0x60000045, "Overlay Subtype", VR.kLO,
          VM.k1, false);
  ...
  static const PTag kOverlayLocation
      //(6000,0200)
      = const PTag._("OverlayLocation", 0x60000200, "Overlay Location", VR.kUS,
          VM.k1, true);
  ...
  static const PTag kOverlaysGreen
      //(6000,1202)
      = const PTag._("OverlaysGreen", 0x60001202, "Overlays - Green", VR.kUS,
          VM.k1_n, true);
  ...
  static const PTag kItem
      //(FFFE,E000)
      = const PTag._("Item", 0xFFFEE000, "Item", VR.kInvalid, VM.kNoVM, false);
  static const PTag kItemDelimitationItem
      //(FFFE,E00D)
      = const PTag._("ItemDelimitationItem", 0xFFFEE00D,
          "Item Delimitation Item", VR.kInvalid, VM.kNoVM, false);
  static const PTag kSequenceDelimitationItem
      //(FFFE,E0DD)
      = const PTag._("SequenceDelimitationItem", 0xFFFEE0DD,
...
class PublicGroupLengthTag extends PTag {
