...
class DcmDir {
  ...
  const DcmDir(this.keyword, this.code, this.name, this.vr, this.vm, this.isRetired);
  ...
  static const DcmDir kFileSetDescriptorFileID = const DcmDir(
      "FileSetDescriptorFileID", 0x00041130, "File-set Descriptor File ID", VR.kCS, VM.k1_8,
      false);

  static const DcmDir kSpecificCharacterSetOfFileSetDescriptorFile = const DcmDir(
  ...
  static const DcmDir kOffsetOfTheFirstDirectoryRecordOfTheRootDirectoryEntity = const DcmDir(
      "OffsetOfTheFirstDirectoryRecordOfTheRootDirectoryEntity",
      0x00041200,
      "SOffset of the First Directory Record of the Root Directory Entity", VR.kUL, VM.k1, false);

  static const DcmDir kOffsetOfTheLastDirectoryRecordOfTheRootDirectoryEntity = const DcmDir(
      "OffsetOfTheLastDirectoryRecordOfTheRootDirectoryEntity",
      0x00041202,
      "Offset of the Last Directory Record of the Root Directory Entity", VR.kUL, VM.k1, false);

  static const DcmDir kFileSetConsistencyFlag = const DcmDir(
      "FileSetConsistencyFlag",
      0x00041212,
      "File-set Consistency Flag", VR.kUS, VM.k1, false);

  static const DcmDir kDirectoryRecordSequence = const DcmDir(
      "DirectoryRecordSequence",
      0x00041220,
      "Directory Record Sequence", VR.kSQ, VM.k1, false);

  static const DcmDir kOffsetOfTheNextDirectoryRecord = const DcmDir(
      "OffsetOfTheNextDirectoryRecord",
      0x00041400,
      "Offset of the Next Directory Record", VR.kUL, VM.k1, false);
