...
class DcmDir {
  ...
  static const DcmDir kFileSetID =
      const DcmDir("FileSetID", 0x00041130, "File-set ID", VR.kCS, VM.k1, false);

  static const DcmDir kFileSetDescriptorFileID = const DcmDir("FileSetDescriptorFileID",
      0x00041130, "File-set Descriptor File ID", VR.kCS, VM.k1_8, false);
  ...
  static const DcmDir kFileSetConsistencyFlag = const DcmDir("FileSetConsistencyFlag",
      0x00041212, "File-set Consistency Flag", VR.kUS, VM.k1, false);

  static const DcmDir kDirectoryRecordSequence = const DcmDir("DirectoryRecordSequence",
  ...
  static const DcmDir kPrivateRecordUID = const DcmDir(
      "PrivateRecordUID", 0x0004, "Private Record UID", VR.kUI, VM.k1, false);
