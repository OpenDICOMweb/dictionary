...
class PublicTag extends Tag {
  ...
  PublicTag lookupKeyword(String keyword, [bool shouldThrow = true]) {
    ...
    if ((code >= 0x00283100) && (code <= 0x002031FF))
      return PublicTag.kSourceImageIDs;
    ...
    if ((code >= 0x00280412) && (code <= 0x002804F2))
      return PublicTag.kCoefficientCoding;
    // (0028,04X3)
    if ((code >= 0x00280413) && (code <= 0x002804F3))
      return PublicTag.kCoefficientCodingPointers;

    // (0028,08x0)
    if ((code >= 0x00280810) && (code <= 0x002808F0))
      return PublicTag.kCodeLabel;
    // (0028,08x2)
    if ((code >= 0x00280812) && (code <= 0x002808F2))
      return PublicTag.kNumberOfTables;
    // (0028,08x3)
    if ((code >= 0x00280813) && (code <= 0x002808F3))
      return PublicTag.kCodeTableLocation;
    // (0028,08x4)
    if ((code >= 0x00280814) && (code <= 0x002808F4))
      return PublicTag.kBitsForCodeWord;
    // (0028,08x8)
    if ((code >= 0x00280818) && (code <= 0x002808F8))
      return PublicTag.kImageDataLocation;

    //**** (1000,xxxy ****
    // (1000,04X2)
    if ((code >= 0x10000000) && (code <= 0x1000FFF0))
      return PublicTag.kEscapeTriplet;
    // (1000,04X3)
    if ((code >= 0x10000001) && (code <= 0x1000FFF1))
      return PublicTag.kRunLengthTriplet;
    // (1000,08x0)
    if ((code >= 0x10000002) && (code <= 0x1000FFF2))
      return PublicTag.kHuffmanTableSize;
    // (1000,08x2)
    if ((code >= 0x10000003) && (code <= 0x1000FFF3))
      return PublicTag.kHuffmanTableTriplet;
    // (1000,08x3)
    if ((code >= 0x10000004) && (code <= 0x1000FFF4))
      return PublicTag.kShiftTableSize;
    // (1000,08x4)
    if ((code >= 0x10000005) && (code <= 0x1000FFF5))
      return PublicTag.kShiftTableTriplet;
    // (1000,08x8)
    if ((code >= 0x10100000) && (code <= 0x1010FFFF))
      return PublicTag.kZonalMap;
  ...
  static const PublicTag kFileMetaInformationGroupLength = const PublicTag("FileMetaInformationGroupLength",
                                                                     0x00020000, "File Meta Information Group Length", VR.kUL, VM.k1, false);

  static const PublicTag kFileMetaInformationVersion = const PublicTag("FileMetaInformationVersion", 0x00020001,
  ...
  static const PublicTag kMediaStorageSOPInstanceUID = const PublicTag("MediaStorageSOPInstanceUID", 0x00020003,
                                                                 "Media Storage SOP Instance UID", VR.kUI, VM.k1, false);

  static const PublicTag kTransferSyntaxUID =
  ...
  static const PublicTag kSourceApplicationEntityTitle = const PublicTag("SourceApplicationEntityTitle", 0x00020016,
                                                                   "Source ApplicationEntity Title", VR.kAE, VM.k1, false);

  static const PublicTag kSendingApplicationEntityTitle = const PublicTag("SendingApplicationEntityTitle",
                                                                    0x00020017, "Sending Application Entity Title", VR.kAE, VM.k1, false);

  static const PublicTag kReceivingApplicationEntityTitle = const PublicTag("ReceivingApplicationEntityTitle",
                                                                      0x00020018, "Receiving Application Entity Title", VR.kAE, VM.k1, false);

  static const PublicTag kPrivateInformationCreatorUID = const PublicTag("PrivateInformationCreatorUID", 0x00020100,
                                                                   "Private Information Creator UID", VR.kUI, VM.k1, false);

  static const PublicTag kPrivateInformation =
  ...
  static const PublicTag kRecordInUseFlag =
  ...
  static const PublicTag kNumberOfReferences =
  ...
  static const PublicTag kBlockIdentifyingInformationStatus = const PublicTag("BlockIdentifyingInformationStatus",
                                                                        0x00080303, "Block Identifying Information Status", VR.kCS, VM.k1, false);

  static const PublicTag kNonidentifyingPrivateElements = const PublicTag("NonidentifyingPrivateElements",
                                                                    0x00080304, "Nonidentifying Private Elements", VR.kUS, VM.k1_n, false);
  static const PublicTag kDeidentificationActionSequence = const PublicTag("DeidentificationActionSequence",
                                                                     0x00080305, "Deidentification Action Sequence", VR.kSQ, VM.k1, false);
  static const PublicTag kIdentifyingPrivateElements = const PublicTag("IdentifyingPrivateElements", 0x00080306,
  ...
  //(0072,0073)
  = const PublicTag("SelectorODValue", 0x00720073, "Selector OD Value", VR.kOD, VM.k1, false);
  ...
  static const PublicTag kFloatPixelData =
  ...
  //(FFFE,E0DD)
  = const PublicTag("SequenceDelimitationItem", 0xFFFEE0DD, "Sequence Delimitation Item", VR.kUnknown,
                        VM.kNoVM, false);
  ...
  //(0028,0402)
  static const PublicTag kCoefficientCoding =
