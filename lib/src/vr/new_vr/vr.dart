...
class VR<T> {
  ...
  static const VR kCS = VRDcmString.kCS;
...
class VRSequence extends VR {
  ...
  const VRSequence(int index, int code, String id, int elementSize,
  ...
  //Bulkdata Reference
  static const VRSequence kSQ = const VRSequence._(VR.kSQ, true);
}
