...
import 'package:dictionary/src/uid/well_known/wk_uids_map.dart';
...
class WKUid extends UidString {
  ...
  const WKUid(String value, this.type, this.isRetired, this.name)
  ...
  static const WKUid kRLELossless = const WKUid(
  ...
  static const WKUid kXMLEncoding = const WKUid(
  ...
  static const WKUid kBasicStudyContentNotificationSOPClass_Retired =
      const WKUid("1.2.840.10008.1.9", UidType.kSOPClass, true,
  ...
  static const WKUid kPrinterSOPClass = const WKUid(
  ...
  static const WKUid kPrinterSOPInstance = const WKUid("1.2.840.10008.5.1.1.17",
  ...
  static const WKUid kVOILUTBoxSOPClass = const WKUid("1.2.840.10008.5.1.1.22",
      UidType.kSOPClass, false, "VOI LUT Box SOP Class");
  ...
  static const WKUid kCTImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.2",
      UidType.kSOPClass, false, "CT Image Storage");
  ...
  static const WKUid kMRImageStorage = const WKUid("1.2.840.10008.5.1.4.1.1.4",
      UidType.kSOPClass, false, "MR Image Storage");
  ...
  static const WKUid kRawDataStorage = const WKUid("1.2.840.10008.5.1.4.1.1.66",
      UidType.kSOPClass, false, "Raw Data Storage");
  ...
  static const WKUid kdicomManufacturer = const WKUid(
  ...
  static const WKUid kdicomPort = const WKUid(
  ...
  static const WKUid kdicomTransferRole = const WKUid(
  ...
  static const WKUid kdicomStationName = const WKUid(
  ...
  static const WKUid kdicomUniqueAETitle = const WKUid(
