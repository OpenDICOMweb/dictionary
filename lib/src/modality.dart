...
class ModalityType {
  ...
  static const ModalityType AU =
      const ModalityType("AU", "Audio", MClass.ACQUISITION, false, null);
  static const ModalityType BDUS = const ModalityType(
      "BDUS", "Bone Densitometry (ultrasound)", MClass.ACQUISITION, false, null);
  static const ModalityType BI =
      const ModalityType("BI", "Biomagnetic imaging", MClass.ACQUISITION, false, null);
  static const ModalityType BMD = const ModalityType(
      "BMD", "Bone Densitometry (X-Ray)", MClass.ACQUISITION, false, null);
  ...
  static const ModalityType DOC =
      const ModalityType("DOC", "Document", MClass.DOCUMENT, false, null);
  ...
  static const ModalityType EPS = const ModalityType(
      "EPS", "Cardiac Electrophysiology", MClass.ACQUISITION, false, null);
  static const ModalityType ES =
      const ModalityType("ES", "Endoscopy", MClass.ACQUISITION, false, null);
  static const ModalityType FID =
      const ModalityType("FID", "Fiducials", MClass.ACQUISITION, false, null);
  static const ModalityType GM =
      const ModalityType("GM", "General Microscopy", MClass.ACQUISITION, false, null);
  static const ModalityType HC =
      const ModalityType("HC", "Hard Copy", MClass.OTHER, false, null);
  ...
  static const ModalityType IVOCT = const ModalityType("IVOCT",
      "Intravascular Optical Coherence Tomography", MClass.ACQUISITION, false, null);
  static const ModalityType IVUS = const ModalityType(
      "IVUS", "Intravascular Ultrasound", MClass.ACQUISITION, false, null);
  static const ModalityType KER =
      const ModalityType("KER", "Keratometry", MClass.ACQUISITION, false, null);
  static const ModalityType KO = const ModalityType(
      "KO", "Key Object Selection", MClass.POST_PROCESSING, false, null);
  static const ModalityType LEN =
      const ModalityType("LEN", "Lensometry", MClass.ACQUISITION, false, null);
  static const ModalityType LS =
      const ModalityType("LS", "Laser surface scan", MClass.ACQUISITION, false, null);
  static const ModalityType MG =
      const ModalityType("MG", "Mammography", MClass.ACQUISITION, false, null);
  ...
  static const ModalityType OAM = const ModalityType(
      "OAM", "Ophthalmic Axial Measurements", MClass.POST_PROCESSING, false, null);
  static const ModalityType OCT = const ModalityType("OCT",
      "Optical Coherence Tomography (non-Ophthalmic)", MClass.ACQUISITION, false, null);
  static const ModalityType OPM = const ModalityType(
      "OPM", "Ophthalmic Mapping", MClass.POST_PROCESSING, false, null);
  ...
  static const ModalityType OPV = const ModalityType(
      "OPV", "Ophthalmic Visual Field", MClass.ACQUISITION, false, null);
  static const ModalityType OSS =
      const ModalityType("OSS", "Optical Surface Scan", MClass.ACQUISITION, false, null);
  static const ModalityType OT =
      const ModalityType("OT", "Other", MClass.ACQUISITION, false, null);
  static const ModalityType PLAN =
      const ModalityType("PLAN", "Plan", MClass.POST_PROCESSING, false, null);
  static const ModalityType PR =
      const ModalityType("PR", "Presentation State", MClass.POST_PROCESSING, false, null);
  static const ModalityType PT = const ModalityType(
      "PT", "Positron emission tomography (PET)", MClass.ACQUISITION, false, null);
  //TODO: determine the correct code for PET/CT
  static const ModalityType PTCT = const ModalityType(
      "PTCT",
  ...
  static const ModalityType RG = const ModalityType("RG",
      "Radiographic imaging (conventional film/screen)", MClass.ACQUISITION, false, null);
  static const ModalityType RTDOSE =
      const ModalityType("RTDOSE", "Radiotherapy Dose", MClass.ACQUISITION, false, null);
  static const ModalityType RTIMAGE = const ModalityType(
      "RTIMAGE", "Radiotherapy Image", MClass.ACQUISITION, false, null);
  static const ModalityType RTPLAN = const ModalityType(
      "RTPLAN", "Radiotherapy Plan", MClass.POST_PROCESSING, false, null);
  static const ModalityType RTRECORD =
      const ModalityType("RTRECORD", "RT Treatment Record", MClass.DOCUMENT, false, null);
  static const ModalityType RTSTRUCT = const ModalityType(
      "RTSTRUCT", "Radiotherapy Structure Set", MClass.PLANNING, false, null);
  ...
  static const ModalityType SR =
      const ModalityType("SR", "SR Document", MClass.DOCUMENT, false, null);
  static const ModalityType STAIN = const ModalityType(
      "STAIN", "Automated Slide Stainer", MClass.ACQUISITION, false, null);
  static const ModalityType TG =
      const ModalityType("TG", "Thermography", MClass.ACQUISITION, false, null);
  static const ModalityType US =
      const ModalityType("US", "Ultrasound", MClass.ACQUISITION, false, null);
  static const ModalityType VA =
      const ModalityType("VA", "Visual Acuity", MClass.ACQUISITION, false, null);
  static const ModalityType XA =
      const ModalityType("XA", "X-Ray Angiography", MClass.ACQUISITION, false, null);
  static const ModalityType XC = const ModalityType(
      "XC", "External-camera Photography", MClass.ACQUISITION, false, null);
  static const ModalityType AS =
      const ModalityType("AS", "Angioscopy", MClass.ACQUISITION, true, null);
  ...
  static const ModalityType CF =
      const ModalityType("CF", "Cinefluorography", MClass.ACQUISITION, true, RF);
  static const ModalityType CP =
      const ModalityType("CP", "Culposcopy", MClass.ACQUISITION, true, null);
  static const ModalityType CS =
      const ModalityType("CS", "Cystoscopy", MClass.ACQUISITION, true, null);
  static const ModalityType DD =
      const ModalityType("DD", "Duplex Doppler", MClass.ACQUISITION, true, US);
  ...
  static const ModalityType DS = const ModalityType(
      "DS", "Digital Subtraction Angiography", MClass.ACQUISITION, true, XA);
  static const ModalityType EC =
      const ModalityType("EC", "Echocardiography", MClass.ACQUISITION, true, US);
  static const ModalityType FA =
      const ModalityType("FA", "Fluorescein angiography", MClass.ACQUISITION, true, null);
  static const ModalityType FS =
      const ModalityType("FS", "Fundoscopy", MClass.ACQUISITION, true, null);
  static const ModalityType LP =
      const ModalityType("LP", "Laparoscopy", MClass.ACQUISITION, true, null);
  static const ModalityType MA = const ModalityType(
      "MA", "Magnetic resonance angiography", MClass.ACQUISITION, true, MR);
  static const ModalityType MS = const ModalityType(
      "MS", "Magnetic resonance spectroscopy", MClass.ACQUISITION, true, MR);
  static const ModalityType OPR =
      const ModalityType("OPR", "Ophthalmic Refraction", MClass.ACQUISITION, true, null);
  static const ModalityType ST = const ModalityType("ST",
