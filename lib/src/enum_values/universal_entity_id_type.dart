...
class UniversalEntityIDType extends EnumValue<String> {
  ...
  static const DNS = const UniversalEntityIDType(0, "DNS", "Domain Name System", Term.DNS);
  static const EUI64 =
      const UniversalEntityIDType(0, "EUI64", "IEEE Extended Unique Idnetifier", Term.EUI64);
  static const ISO = const UniversalEntityIDType(0, "DNS", "Domain Name System", Term.ISO);
  static const URI =
  ...
  static const X400 = const UniversalEntityIDType(0, "X400", "X400 MHS Identifier", Term.X400);
  static const X500 = const UniversalEntityIDType(0, "X500", "X500 Directory Name", Term.X500);
